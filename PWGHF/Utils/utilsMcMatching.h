...
std::unordered_map<hf_cand_3prong::DecayChannelMain, const std::vector<int>> getDecayChannel3Prong(int pdgMother)
{
  switch (pdgMother) {
    case Pdg::kDPlus:
      return hf_chns_3prong::finalStatesDPlus;
    case Pdg::kDS:
      return hf_chns_3prong::finalStatesDs;
    case Pdg::kDStar:
      return hf_chns_3prong::finalStatesDstar;
    case Pdg::kLambdaCPlus:
      return hf_chns_3prong::finalStatesLc;
    case Pdg::kXiCPlus:
      return hf_chns_3prong::finalStatesXic;
    default:
...
std::unordered_map<hf_cand_3prong::DecayChannelResonant, const std::array<int, 2>> getResoChannels3Prong(int pdgMother)
{
  switch (pdgMother) {
    case Pdg::kDPlus:
      return hf_chns_3prong::resoStatesDPlus;
    case Pdg::kDS:
      return hf_chns_3prong::resoStatesDs;
    case Pdg::kDStar:
      return hf_chns_3prong::resoStatesDstar;
    case Pdg::kLambdaCPlus:
      return hf_chns_3prong::resoStatesLambdaC;
    case Pdg::kXiCPlus:
      return hf_chns_3prong::resoStatesXiC;
    default:
      LOG(error) << "Unknown PDG code for 3-prong final states: " << pdgMother;
      return {};
  }
...
void flagResonantDecay(int motherPdg, int8_t* channel, std::array<int, N> const& arrDaughPdgs)
{
  if constexpr (is3Prong) {
    std::unordered_map<hf_cand_3prong::DecayChannelResonant, const std::array<int, 2>> resoStates = getResoChannels3Prong(motherPdg);
