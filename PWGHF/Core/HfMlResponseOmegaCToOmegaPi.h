...
enum class InputFeaturesOmegacToOmegaPi : uint8_t {
  xPv = 0 , yPv ,zPv ,
  xDecayVtxCharmBaryon ,yDecayVtxCharmBaryon ,zDecayVtxCharmBaryon ,
  xDecayVtxCascade ,yDecayVtxCascade ,zDecayVtxCascade ,
  xDecayVtxV0 ,yDecayVtxV0 ,zDecayVtxV0 ,
  signDecay ,
  covVtxCharmBaryon0,covVtxCharmBaryon1,covVtxCharmBaryon2,covVtxCharmBaryon3,covVtxCharmBaryon4,covVtxCharmBaryon5,
  pxCharmBaryon ,pyCharmBaryon ,pzCharmBaryon ,
  pxCasc ,pyCasc ,pzCasc ,
  pxPiFromCharmBaryon ,pyPiFromCharmBaryon ,pzPiFromCharmBaryon ,
  pxLambda ,pyLambda ,pzLambda ,
  pxKaFromCasc ,pyKaFromCasc ,pzKaFromCasc ,
  pxPosV0Dau ,pyPosV0Dau ,pzPosV0Dau ,
  pxNegV0Dau ,pyNegV0Dau ,pzNegV0Dau ,
  impactParCascXY ,impactParPiFromCharmBaryonXY ,
  errImpactParCascXY ,errImpactParPiFromCharmBaryonXY ,
  invMassLambda ,invMassCascade,invMassCharmBaryon,
  cosPAV0,cosPACharmBaryon,cosPACasc,cosPAXYV0,cosPAXYCharmBaryon,cosPAXYCasc,
  ctauOmegac,ctauCascade,ctauV0,
  etaV0PosDau,etaV0NegDau,etaKaFromCasc,etaPiFromCharmBaryon,etaCharmBaryon,etaCascade,etaV0,
  dcaXYToPvV0Dau0,dcaXYToPvV0Dau1,dcaXYToPvCascDau,dcaCascDau,dcaV0Dau,dcaCharmBaryonDau,
  decLenCharmBaryon,decLenCascade,decLenV0,errorDecayLengthCharmBaryon,errorDecayLengthXYCharmBaryon,
  ptCharmBaryon,ptCasc,ptPiFromCharmBaryon,
  nSigTpcPi0,
  nSigTpcPr0,
  nSigTofPi0,
  nSigTofPr0,
...
#endif // PWGHF_CORE_HFMLRESPONSEOMEGAC0TOOMEGAPI_H_
