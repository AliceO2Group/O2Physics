...
struct HfTreeCreatorLcToK0sP {
  ...
  void fillCandidate(const T& candidate, const U& bach, int8_t flagMc, int8_t originMcRec)
  {
    rowCandidateFull(
      ...
      candidate.mK0Short(),
      candidate.mGamma(),
      o2::aod::hf_cand_casc::hfHelper.ctV0K0s(candidate),
      o2::aod::hf_cand_casc::hfHelper.ctV0Lambda(candidate),
      ...
      bach.tpcNSigmaPr(),
      bach.tofNSigmaPr(),
      o2::aod::hf_cand_casc::hfHelper.invMassLcToK0sP(candidate),
      candidate.pt(),
      candidate.p(),
      candidate.cpa(),
      candidate.cpaXY(),
      o2::aod::hf_cand_3prong::hfHelper.ctLc(candidate),
      candidate.eta(),
      candidate.phi(),
      o2::aod::hf_cand_3prong::hfHelper.yLc(candidate),
      o2::aod::hf_cand_3prong::hfHelper.eLc(candidate),
      flagMc,
      originMcRec);
  }
