...
struct HfCandidateSelectorXicToXiPiPi {
  ...
  void init(InitContext&)
  {
    ...
    if (fillHistogram) {
      constexpr int kNBinsSelectionCriteria = NSelectionCriteria;
      ...
      if (doprocessData) {
        registry.add("hSelCandidates", ";;entries", {HistType::kTH1F, {{kNBinsSelectionCriteria, -0.5f, static_cast<float>(kNBinsSelectionCriteria) - 0.5f}}});
        ...
        registry.add("hSelCandidatesRecSig", ";;entries", {HistType::kTH1F, {{kNBinsSelectionCriteria, -0.5f, static_cast<float>(kNBinsSelectionCriteria) - 0.5f}}});
        registry.add("hSelCandidatesRecBkg", ";;entries", {HistType::kTH1F, {{kNBinsSelectionCriteria, -0.5f, static_cast<float>(kNBinsSelectionCriteria) - 0.5f}}});
        for (int iBin = 0; iBin < NSelectionCriteria; ++iBin) {
