...
struct HFChicToJpsiGammaPCMCandidateSelector {

  Produces<aod::HFSelChicToJpsiGammaPCMCandidate> hfSelChicToJpsiGammaPCMCandidate;
...
{
  return WorkflowSpec{
    adaptAnalysisTask<HFChicToJpsiGammaPCMCandidateSelector>(cfgc, TaskName{"hf-chic-tojpsigammaPCM-candidate-selector"})};
}
