...
struct HfCandidateSelectorDsToKKPi {
  ...
  Configurable<std::string> modelPathsCCDB{"modelPathsCCDB", "EventFiltering/PWGHF/BDTDs", "Path on CCDB"};
  Configurable<std::vector<std::string>> onnxFilesCCDB{"onnxFilesCCDB", std::vector<std::string>{"ModelHandler_onnx_DsToKKPi.onnx"}, "ONNX file names on CCDB, for each pT bin"};
