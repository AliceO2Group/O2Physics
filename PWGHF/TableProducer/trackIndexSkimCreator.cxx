...
struct HfTrackIndexSkimCreator {
  ...
  void init(InitContext const&)
  {
    if (!doprocess2And3ProngsWithPvRefit && !doprocess2And3ProngsNoPvRefit && !process2And3ProngsWithPvRefitWithPidForHfFiltersBdt && !process2And3ProngsNoPvRefitWithPidForHfFiltersBdt) {
      return;
    }
    ...
    if (config.fillHistograms) {
      ...
      // needed for PV refitting
      if (doprocess2And3ProngsWithPvRefit || process2And3ProngsWithPvRefitWithPidForHfFiltersBdt) {
        AxisSpec axisCollisionX{100, -20.f, 20.f, "X (cm)"};
        AxisSpec axisCollisionY{100, -20.f, 20.f, "Y (cm)"};
        AxisSpec axisCollisionZ{100, -20.f, 20.f, "Z (cm)"};
                                ...
                                std::array<float, 6>& pvCovMatrix)
  {
    ...
    if (!pvRefitDoable) {
      LOG(info) << "Not enough tracks accepted for the refit";
      if ((doprocess2And3ProngsWithPvRefit || process2And3ProngsWithPvRefitWithPidForHfFiltersBdt) && config.fillHistograms) {
        registry.fill(HIST("PvRefit/hNContribPvRefitNotDoable"), collision.numContrib());
      }
    }
    if (config.debugPvRefit) {
    ...
    if ((doprocess2And3ProngsWithPvRefit || process2And3ProngsWithPvRefitWithPidForHfFiltersBdt) && pvRefitDoable) {
      if (config.fillHistograms) {
