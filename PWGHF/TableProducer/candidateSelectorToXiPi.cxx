...
struct HfCandidateSelectorToXiPi {
  ...
  void processCombinatoricsData(aod::HfCandToXiPi const& candidates,
                                TracksSel const&)
  {
  ...
  PROCESS_SWITCH(HfCandidateSelectorToXiPi, processCombinatoricsData, "Process dedicated combinatorics data", true);


  void processDerivedData(aod::HfCandToXiPiDD const& candidates,
                          TracksSel const&)
  {
  ...
  PROCESS_SWITCH(HfCandidateSelectorToXiPi, processDerivedData, "Process derived data", false);
