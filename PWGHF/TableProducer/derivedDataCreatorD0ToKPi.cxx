...
struct HfDerivedDataCreatorD0ToKPi {
  ...
  Partition<SelectedCandidatesMc> candidatesMcSig = (nabs(aod::hf_cand_mc_flag::flagMcMatchRec) == static_cast<int8_t>(o2::hf_decay::hf_cand_2prong::DecayChannelMain::D0ToPiK)) || (fillCorrelatedBkgs && aod::hf_cand_mc_flag::flagMcMatchRec != 0);
  ...
  Partition<SelectedCandidatesMcKf> candidatesMcKfSig = (nabs(aod::hf_cand_mc_flag::flagMcMatchRec) == static_cast<int8_t>(o2::hf_decay::hf_cand_2prong::DecayChannelMain::D0ToPiK)) || (fillCorrelatedBkgs && aod::hf_cand_mc_flag::flagMcMatchRec != 0);
  ...
  Partition<SelectedCandidatesMcMl> candidatesMcMlSig = (nabs(aod::hf_cand_mc_flag::flagMcMatchRec) == static_cast<int8_t>(o2::hf_decay::hf_cand_2prong::DecayChannelMain::D0ToPiK)) || (fillCorrelatedBkgs && aod::hf_cand_mc_flag::flagMcMatchRec != 0);
  ...
  Partition<SelectedCandidatesMcKfMl> candidatesMcKfMlSig = (nabs(aod::hf_cand_mc_flag::flagMcMatchRec) == static_cast<int8_t>(o2::hf_decay::hf_cand_2prong::DecayChannelMain::D0ToPiK)) || (fillCorrelatedBkgs && aod::hf_cand_mc_flag::flagMcMatchRec != 0);
