...
struct HfCandidateSelectorLbToLcPi {
  ...
  void process(aod::HfCandLb const& hfCandLbs, soa::Join<aod::HfCand3Prong const&, aod::HfSelLc> const&, aod::BigTracks const&)
  {
    for (auto& hfCandLb : hfCandLbs) { // looping over Lb candidates
      ...
      auto trackPi = hfCandLb.prong1_as<aod::BigTracks>();
