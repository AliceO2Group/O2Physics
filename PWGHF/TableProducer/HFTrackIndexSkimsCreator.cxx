...
struct HfTagSelCollisions {
  ...
  HistogramRegistry registry{"registry", {{"hNcontributor", "Number of vertex contributor", {HistType::kTH1F, {{20001, -0.5, 20000.5}}}}}};
  ...
  {
    registry.fill(HIST("hNcontributor"), collision.numContrib());
    // x position
