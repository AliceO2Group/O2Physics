...
DECLARE_SOA_COLUMN(ImpactParKaFromCharmBaryonZ, impactParKaFromCharmBaryonZ, float);
...
DECLARE_SOA_TABLE(HfOmegac0ToOmegaPiFulls, "AOD", "HFTOOMEPIFULL",
                  ...
                  full::PxKaFromCharmBaryon, full::PyPiFromCharmBaryon, full::PzPiFrKaCharmBaryon,
                  ...
                  full::ImpactParCascZ, full::ImpactParKaFromCharmBaryonZ,
                  ...
                  full::NormImpParCascade, full::NormImpParKaFromCharmBar, full::NormDecayLenCharmBar, full::IsPionGlbTrkWoDca, full::PionItsNCls,
...
struct HfTreeCreatorOmegac0ToOmegaKa {
  ...
  Produces<o2::aod::HfOmegac0ToOmegaKaFulls> rowCandidateFull;
  ...
  PROCESS_SWITCH(HfTreeCreatorOmegac0ToOmegaKa, processDataFull, "Process data with full information", true);
  ...
  PROCESS_SWITCH(HfTreeCreatorOmegac0ToOmegaKa, processMcFull, "Process MC with full information", false);
  ...
  PROCESS_SWITCH(HfTreeCreatorOmegac0ToOmegaKa, processDataLite, "Process data and produce lite table version", false);
  ...
  PROCESS_SWITCH(HfTreeCreatorOmegac0ToOmegaKa, processMcLite, "Process MC and produce lite table version", false);
