...
struct HfDerivedDataCreatorLcToPKPi {
  ...
  HfHelper hfHelper;
  SliceCache cache;
  static constexpr double massLc{o2::constants::physics::MassLambdaCPlus};
                    ...
                    aod::BCs const& bcs)
  {
    ...
    rowsCommon.processMcParticles(mcCollisions, mcParticlesPerMcCollision, mcParticles, massLc);
  }
