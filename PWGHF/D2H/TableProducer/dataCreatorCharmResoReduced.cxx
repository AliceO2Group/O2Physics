...
struct HfDataCreatorCharmResoReduced {
  ...
  void init(InitContext& initContext)
  {
    ...
    registry.add("hMassVsPtD0BarAll", "D0 candidates (all, regardless the pairing with V0s);#it{p}_{T} (GeV/#it{c});inv. mass (GeV/#it{c}^{2});entries", {HistType::kTH2D, {axisPt, axisMassD0}});
    ...
    // MC Rec
    registry.add("hMCRecCounter", "Number of Reconstructed MC Matched candidates per channel", {HistType::kTH1D, {{33, -16.5, 16.5}}});
    ...
    registry.add("hMCRecMassGen", "Generated inv. mass of resoncances", {HistType::kTH1D, {{3000, 2.2, 3.7}}});
    registry.add("hMCRecCharmDau", "D meson daughters matching flag", {HistType::kTH1D, {{51, -25.5, 25.5}}});
    // MC Gen
    registry.add("hMCGenCounter", "Number of Generated particles; Decay Channel Flag; pT [GeV/c]", {HistType::kTH2D, {{33, -16.5, 16.5}, {100, 0, 50}}});
