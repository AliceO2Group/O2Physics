...
void fillHisto (const Cand& candidate){
    ...
    registry.fill(HIST("hSparseMl"), candidate.pt(), candidate.ptProng0(), candidate.ptProng1(), candidate.invMass(), candidate.invMassProng0(), candidate.invMassProng1(), candidate.cosThetaStarDs2Star(), candidate.mlScoreBkgProng0(), candidate.mlScoreNonpromptProng0());
} // fillHisto
