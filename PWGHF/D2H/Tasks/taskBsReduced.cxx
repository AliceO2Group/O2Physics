...
struct HfTaskBsReduced {
  ...
  void init(InitContext&)
  {
    ...
    std::array<bool, 5> processFuncMc{doprocessMc, doprocessMcWithDecayTypeCheck, doprocessMcWithDmesMl, doprocessMcWithBsMl, doprocessMcWithBsMlAndDecayTypeCheck};
