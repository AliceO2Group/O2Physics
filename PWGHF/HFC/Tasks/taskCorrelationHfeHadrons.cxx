...
struct HfCorrelatorElHadrons {
  ...
  HistogramRegistry registry{
    ...
    {{"hNevents", "hNevents", {HistType::kTH1F, {{3, 1, 4}}}},
     ...
     {"fSprsHHCorrl", "Sparse for Dphi and Deta with Inclusive electron;p_{T}^{e} (GeV#it{/c});p_{T}^{h} (GeV#it{/c});#Delta#varphi;#Delta#eta;", hCorrelSpec},
     {"fSprsInclusiveEHCorrl", "Sparse for Dphi and Deta with Inclusive electron;p_{T}^{e} (GeV#it{/c});p_{T}^{h} (GeV#it{/c});#Delta#varphi;#Delta#eta;", hCorrelSpec},
     ...
     {"fSprsClusterInfoBe", "Cluster Info before match; Energy (GeV);#eta;#varphi", hClusterInfoSpec},
...
{
  return WorkflowSpec{adaptAnalysisTask<HfCorrelatorElHadrons>(cfgc)};
}
