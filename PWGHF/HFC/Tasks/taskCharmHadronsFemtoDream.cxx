...
struct HfTaskCharmHadronsFemtoDream {
  ...
  Filter hfCandSelFilter = aod::fdhf::candidateSelFlag >= static_cast<int>(charmHadCandSel.value);
  Filter hfMcSelFilter = nabs(aod::fdhf::flagMc) == static_cast<int>(charmHadMcSel.value);
