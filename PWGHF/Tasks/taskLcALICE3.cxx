               ...
               soa::Join<aod::McParticles, aod::HfCandProng3MCGen> const& particlesMC, aod::BigTracksMC const& tracks)
  {
    for (auto& candidate : candidates) {
      ...
      if (candidate.isSelLcPKPiNoPID() >= 1) {
        ...
        if (candidate.flagMCMatchRec() == (1 << DecayType::LcToPKPi) && candidate.isSelLcPKPiPerfectPID() >= 1 && candidate.isSelLcPiKPPerfectPID() < 1) {
      ...
      if (candidate.isSelLcPiKPNoPID() >= 1) {
        ...
        if (candidate.flagMCMatchRec() == (1 << DecayType::LcToPKPi) && candidate.isSelLcPiKPPerfectPID() >= 1 && candidate.isSelLcPKPiPerfectPID() < 1) {
