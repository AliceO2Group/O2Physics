...
struct TaskLc {
  ...
  void init(o2::framework::InitContext&)
  {
    ...
    registry.add("hmass", "3-prong candidates;inv. mass (p K #pi) (GeV/#it{c}^{2}); p_{T}; multiplicity", {HistType::kTH3F, {{500, 1.6, 3.1}, {vbins, "#it{p}_{T} (GeV/#it{c})"}, {5000, 0., 10000.}}});
                 ...
                 soa::Join<aod::McParticles_000, aod::HfCandProng3MCGen> const& particlesMC, aod::BigTracksMC const& /*tracks*/)
  {
    ...
    for (auto& candidate : candidates) {
      ...
      if (std::abs(candidate.flagMCMatchRec()) == 1 << DecayType::LcToPKPi) {
        ...
        auto indexMother = RecoDecay::getMother(particlesMC, candidate.index0_as<aod::BigTracksMC>().mcParticle_as<soa::Join<aod::McParticles_000, aod::HfCandProng3MCGen>>(), pdg::Code::kLambdaCPlus, true);
