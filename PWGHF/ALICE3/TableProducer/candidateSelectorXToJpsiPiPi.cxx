...
struct HfCandidateSelectorXToJpsiPiPi {
  ...
  void process(aod::HfCandX const& hfCandXs, aod::HfCand2Prong const&, TracksPid const& tracks)
  {
    for (auto& hfCandX : hfCandXs) { // looping over X candidates
      ...
      auto trackPos = hfCandX.prong1_as<TracksPid>(); // positive daughter
      auto trackNeg = hfCandX.prong2_as<TracksPid>(); // negative daughter
