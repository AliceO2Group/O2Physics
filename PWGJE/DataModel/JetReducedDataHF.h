...
DECLARE_SOA_TABLE(JD0Ids, "AOD1", "JD0Ids",
                  jd0indices::JCollisionId,
                  jd0indices::Prong0Id,
                  jd0indices::Prong1Id);

DECLARE_SOA_TABLE(StoredJD0Ids, "AOD", "JD0Ids",
                  jd0indices::JCollisionId,
                  jd0indices::Prong0Id,
                  jd0indices::Prong1Id,
                  o2::soa::Marker<1>);

DECLARE_SOA_TABLE(JD0PIds, "AOD1", "JD0PIds",
                  jd0indices::JMcCollisionId,
                  jd0indices::JMcParticleId);

DECLARE_SOA_TABLE(StoredJD0PIds, "AOD", "JD0PIds",
                  jd0indices::JMcCollisionId,
                  jd0indices::JMcParticleId,
                  o2::soa::Marker<1>);
