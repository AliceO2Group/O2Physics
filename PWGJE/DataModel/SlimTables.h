...
{
DECLARE_SOA_INDEX_COLUMN(SlimCollision, collision); // o2-linter: disable=name/o2-column
...
{
DECLARE_SOA_INDEX_COLUMN(SlimMcCollision, mcCollision); // o2-linter: disable=name/o2-column
