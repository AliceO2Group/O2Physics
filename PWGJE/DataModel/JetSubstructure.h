...
#define JETSUBSTRUCTURE_TABLE_DEF(_collision_type_, _table_type_, _jet_type_, _matched_jet_type_, _cand_type_, _name_, _description_)                                                                                                                                                                                                                                                \
  ...
  DECLARE_SOA_TABLE(_table_type_##Os, "AOD", _description_ "O", _name_##jetoutput::_table_type_##COId, _name_##jetoutput::CandidateId, _name_##geomatched::_matched_jet_type_##Ids, _name_##ptmatched::_matched_jet_type_##Ids, _name_##candmatched::_matched_jet_type_##Ids, jetoutput::JetPt, jetoutput::JetPhi, jetoutput::JetEta, jetoutput::JetR, jetoutput::JetNConstituents); \
