...
#define JETSUBSTRUCTURE_TABLE_DEF(_jet_type_, _cand_type_, _name_, _description_)                                                                                                                                                         \
  ...
  using _jet_type_##CO = _jet_type_##COs::iterator;                                                                                                                                                                                       \
                                                                                                                                                                                                                                          \
  DECLARE_SOA_TABLE(_jet_type_##DummyHFs, "AOD", _description_ "DHF", _name_##collisionoutput::Dummy##_jet_type_<>)                                                                                                                       \
  ...
  DECLARE_SOA_TABLE(_jet_type_##Os, "AOD", _description_ "O", _name_##jetoutput::_jet_type_##COId, _name_##jetoutput::CandidateId, jetoutput::JetPt, jetoutput::JetPhi, jetoutput::JetEta, jetoutput::JetR, jetoutput::JetNConstituents); \
  ...
  {                                                                                                                                                                                                                                       \
    ...
    DECLARE_SOA_DYNAMIC_COLUMN(Dummy##_jet_type_, dummy##_jet_type_, []() -> int { return 0; });                                                                                                                                          \
                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                          \
  DECLARE_SOA_TABLE(_jet_type_##SSs, "AOD", _description_ "SS", jetsubstructure::EnergyMother, jetsubstructure::PtLeading, jetsubstructure::PtSubLeading, jetsubstructure::Theta, _name_##substructure::Dummy##_jet_type_<>);             \
  DECLARE_SOA_TABLE(_jet_type_##SSOs, "AOD", _description_ "SSO", _name_##substructure::_jet_type_##OId, jetsubstructure::EnergyMother, jetsubstructure::PtLeading, jetsubstructure::PtSubLeading, jetsubstructure::Theta);               \
                                                                                                                                                                                                                                          \
  using _jet_type_##O = _jet_type_##Os::iterator;                                                                                                                                                                                         \
