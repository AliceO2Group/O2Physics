...
DECLARE_SOA_COLUMN(Track1NSigmaE, track1NSigmaE, float);     //! NSigma electron (TPC PID) of first matched track
DECLARE_SOA_COLUMN(Track1NSigmaPi, track1NSigmaPi, float);   //! NSigma pion (TPC PID) of first matched track
...
DECLARE_SOA_COLUMN(Track2NSigmaE, track2NSigmaE, float);     //! NSigma electron (TPC PID) of second matched track
DECLARE_SOA_COLUMN(Track2NSigmaPi, track2NSigmaPi, float);   //! NSigma pion (TPC PID) of second matched track
...
DECLARE_SOA_TABLE(EmcalMTs, "AOD", "EMCALMTS",                                                                                                                                                          //!
                  ...
                  emcaltrackmatch::Track2ITSNCls, emcaltrackmatch::Track2TOFExpMom, emcaltrackmatch::Track2NSigmaE, emcaltrackmatch::Track2NSigmaPi,                                                    // track 2 ITS, TOF and TPC PID info
