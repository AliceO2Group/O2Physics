    ...
    if (collision.isCollisionSelected()) {
      ...
      for (const auto& cluster : clusters) {
        ...
        for (const auto& clusterTrack : cluster.matchedTracks_as<aod::JTracks>()) {
          ...
          products.storedJTracksEMCalTable(trackMapping[clusterTrack.globalIndex()], emcTrackPerTrack.etaEmcal(), emcTrackPerTrack.phiEmcal(), emcTrackPerTrack.deltaEta(), emcTrackPerTrack.deltaPhi());
        }
