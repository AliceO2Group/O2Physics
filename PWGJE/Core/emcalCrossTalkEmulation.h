...
class EMCCrossTalk
{
 ...
 public:
  ...
  /// \brief Getter for modified cells.
  /// \return std::vector<o2::emcal::Cell> of modified cells
  std::vector<o2::emcal::Cell> getModifiedCells() { return mCells; }

  /// \brief Getter for modified cell labels.
  /// \return std::vector<o2::emcal::Cell> of modified cell labels
  std::vector<o2::emcal::CellLabel> getModifiedCellLabels() { return mCellLabels; }
