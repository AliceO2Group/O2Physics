...
struct ft0Qa {
  ...
  static constexpr int kNContribLimit20 = 20; ///< Limit on number of contributors for some histos
                  ...
                  aod::FT0s const&)
  {
    ...
    if (bc.has_ft0()) {
      ...
      for (auto const& amplitude : ft0.amplitudeA()) {
        multFT0A += amplitude;
        histos.fill(HIST("hBcAmpT0A"), amplitude);
      }
      for (auto const& amplitude : ft0.amplitudeC()) {
        multFT0C += amplitude;
