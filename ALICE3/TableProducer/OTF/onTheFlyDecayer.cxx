...
struct OnTheFlyDecayer {
  ...
  void init(o2::framework::InitContext&)
  {
    ...
    histos.add("K0S/hHasDecayed", "hHasDecayed;Decay status", kTH1D, {{2, -0.5, 1.5}});
    histos.get<TH1>("K0S/hHasDecayed")->GetXaxis()->SetBinLabel(1, "Not Decayed");
    histos.get<TH1>("K0S/hHasDecayed")->GetXaxis()->SetBinLabel(2, "Decayed");
    ...
    histos.add("Lambda/hHasDecayed", "hHasDecayed;Decay status", kTH1D, {{2, -0.5, 1.5}});
    histos.get<TH1>("Lambda/hHasDecayed")->GetXaxis()->SetBinLabel(1, "Not Decayed");
    histos.get<TH1>("Lambda/hHasDecayed")->GetXaxis()->SetBinLabel(2, "Decayed");
    ...
    histos.add("AntiLambda/hHasDecayed", "hHasDecayed;Decay status", kTH1D, {{2, -0.5, 1.5}});
    histos.get<TH1>("AntiLambda/hHasDecayed")->GetXaxis()->SetBinLabel(1, "Not Decayed");
    histos.get<TH1>("AntiLambda/hHasDecayed")->GetXaxis()->SetBinLabel(2, "Decayed");
    ...
    histos.add("Xi/hHasDecayed", "hHasDecayed;Decay status", kTH1D, {{2, -0.5, 1.5}});
    histos.get<TH1>("Xi/hHasDecayed")->GetXaxis()->SetBinLabel(1, "Not Decayed");
    histos.get<TH1>("Xi/hHasDecayed")->GetXaxis()->SetBinLabel(2, "Decayed");
    ...
    histos.add("AntiXi/hHasDecayed", "hHasDecayed;Decay status", kTH1D, {{2, -0.5, 1.5}});
    histos.get<TH1>("AntiXi/hHasDecayed")->GetXaxis()->SetBinLabel(1, "Not Decayed");
    histos.get<TH1>("AntiXi/hHasDecayed")->GetXaxis()->SetBinLabel(2, "Decayed");
    ...
    histos.add("Omega/hHasDecayed", "hHasDecayed;Decay status", kTH1D, {{2, -0.5, 1.5}});
    histos.get<TH1>("Omega/hHasDecayed")->GetXaxis()->SetBinLabel(1, "Not Decayed");
    histos.get<TH1>("Omega/hHasDecayed")->GetXaxis()->SetBinLabel(2, "Decayed");
    ...
    histos.add("AntiOmega/hHasDecayed", "hHasDecayed;Decay status", kTH1D, {{2, -0.5, 1.5}});
    histos.get<TH1>("AntiOmega/hHasDecayed")->GetXaxis()->SetBinLabel(1, "Not Decayed");
    histos.get<TH1>("AntiOmega/hHasDecayed")->GetXaxis()->SetBinLabel(2, "Decayed");
  ...
  void process(aod::McCollision const&, aod::McParticles const& mcParticles)
  {
    ...
    for (int index{0}; index < static_cast<int>(allParticles.size()); ++index) {
      ...
      // Do QA on common analysis decay channels
      switch (otfParticle.pdgCode())
      {
      case PDG_t::kK0Short:
        histos.fill(HIST("K0S/hGenK0S", otfParticle.pt()));
        if (otfParticle.isAlive()) {
