...
struct ExclusiveRhoTo4Pi {
  ...
  void init(InitContext const&)
  {
    ...
    histosData.add("avg_eta_pi_vs_runNo", "Average pion #eta vs run number; Run Number; #eta", kTH2F, {{1355, 544013, 545367}, {1000, -1.1, 1.1}});
    ...
    histosData.add("avg_eta_pi_vs_runNo_selected4piEvents", "Average pion #eta vs run number; Run Number; #eta", kTH2F, {{1355, 544013, 545367}, {1000, -1.1, 1.1}});
    ...
    histosData.add("eta_track_all", "Pseudorapidity with track selection; #eta; Counts", kTH1F, {{1000, -1.1, 1.1}});
    histosData.add("eta_track_pions", "Pseudorapidity with track selection and PID selection of Pi; #eta; Events", kTH1F, {{1000, -1.1, 1.1}});
    histosData.add("eta_track_pions_contributed", "Pseudorapidity with track selection and PID selection of Pi which are contributed to selected event; #eta; Events", kTH1F, {{1000, -1.1, 1.1}});
  ...
  // Process Data pass5----------------------------------------------------------------------------------------------------------------------------
  using UDtrackspass5 = soa::Filtered<soa::Join<aod::UDTracks, aod::UDTracksPID, aod::UDTracksExtra, aod::UDTracksFlags, aod::UDTracksDCA>>;
  using UDCollisionspass5 = soa::Filtered<soa::Join<aod::UDCollisions, aod::SGCollisions, aod::UDCollisionSelExtras, aod::UDCollisionsSels, aod::UDZdcsReduced>>;
  using UDCollisionpass5 = UDCollisionspass5::iterator;

  void processDataPass5(UDCollisionpass5 const& collision, UDtrackspass5 const& tracks)
  {
  ...
  // Process Data pass4----------------------------------------------------------------------------------------------------------------------------
  using UDtrackspass4 = soa::Filtered<soa::Join<aod::UDTracks, aod::UDTracksPID, aod::UDTracksExtra, aod::UDTracksFlags, aod::UDTracksDCA>>;
  using UDCollisionspass4 = soa::Filtered<soa::Join<aod::UDCollisions, aod::SGCollisions, aod::UDCollisionSelExtras_001, aod::UDCollisionsSels, aod::UDZdcsReduced>>;
  using UDCollisionpass4 = UDCollisionspass4::iterator;

  void processDataPass4(UDCollisionpass4 const& collision, UDtrackspass4 const& tracks)
  {
  ...
  } // End of 4 Pion Analysis Process function for Pass4 Data

  // Analysis for MC generated data----------------------------------------------------------------------------------------------------------------------------
  ...
  // Analysis for MC reconstructed data----------------------------------------------------------------------------------------------------------------------------
  ...
  PROCESS_SWITCH(ExclusiveRhoTo4Pi, processDataPass5, "The Process for 4 Pion Analysis from pass5 data", false);
  PROCESS_SWITCH(ExclusiveRhoTo4Pi, processDataPass4, "The Process for 4 Pion Analysis from pass4 data", false);
