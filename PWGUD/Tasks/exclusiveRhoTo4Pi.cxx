...
struct exclusiveRhoTo4Pi { // o2-linter: disable=name/workflow-file,name/struct
  ...
  void init(InitContext const&)
  {
    ...
    if (ifDataAnalysis) {
      ...
      histosData.add("tpcNSigmaPi_WTS_PID_Pi_Ka", "TPC nSigma Kaon with track selection and PID Selection of Pion; Entries", kTH1F, {{1000, -15, 15}});
      histosData.add("tpcNSigmaPi_WTS_PID_Pi_Pr", "TPC nSigma Proton with track selection and PID Selection of Pion; Entries", kTH1F, {{1000, -15, 15}});
      histosData.add("tpcNSigmaPi_WTS_PID_Pi_El", "TPC nSigma Electron with track selection and PID Selection of Pion; Entries", kTH1F, {{1000, -15, 15}});
      histosData.add("tpcNSigmaPi_WTS_PID_Pi_Mu", "TPC nSigma Muon with track selection and PID Selection of Pion; Entries", kTH1F, {{1000, -15, 15}});
      ...
      histosData.add("tofNSigmaPi_WTS_PID_Pi_Ka", "TOF nSigma Kaon with track selection and PID Selection of Pion; Entries", kTH1F, {{1000, -15, 15}});
      histosData.add("tofNSigmaPi_WTS_PID_Pi_Pr", "TOF nSigma Proton with track selection and PID Selection of Pion; Entries", kTH1F, {{1000, -15, 15}});
      histosData.add("tofNSigmaPi_WTS_PID_Pi_El", "TOF nSigma Electron with track selection and PID Selection of Pion; Entries", kTH1F, {{1000, -15, 15}});
      histosData.add("tofNSigmaPi_WTS_PID_Pi_Mu", "TOF nSigma Muon with track selection and PID Selection of Pion; Entries", kTH1F, {{1000, -15, 15}});
    ...
    if (ifMCAnalysis) {
      ...
      // Track Stuff
      histosMCreco.add("MCreco_particle_pT", "Generated pT; pT [GeV/c]; Events", kTH1F, {{nBinsPt, 0, 10}});
      histosMCreco.add("MCreco_particle_rapidity", "Generated Rapidity; y; Events", kTH1F, {{nBinsRapidity, -2.5, 2.5}});

      // For 0 charge events
      histosMCreco.add("MCreco_0charge_4pion_pT", "Generated pT; pT [GeV/c]; Events", kTH1F, {{nBinsPt, 0, 2}});
      histosMCreco.add("MCreco_0charge_4pion_rapidity", "Generated Rapidity; y; Events", kTH1F, {{nBinsRapidity, -2.5, 2.5}});
      histosMCreco.add("MCreco_0charge_4pion_invmass", "Invariant Mass of 4-Pions; m(4-pion); Events", kTH1F, {{nBinsInvariantMass, 0.8, 2.5}});

      // For non 0 charge events
      histosMCreco.add("MCreco_non0charge_4pion_pT", "Generated pT; pT [GeV/c]; Events", kTH1F, {{nBinsPt, 0, 2}});
      histosMCreco.add("MCreco_non0charge_4pion_rapidity", "Generated Rapidity; y; Events", kTH1F, {{nBinsRapidity, -2.5, 2.5}});
      histosMCreco.add("MCreco_non0charge_4pion_invmass", "Invariant Mass of 4-Pions; m(4-pion); Events", kTH1F, {{nBinsInvariantMass, 0.8, 2.5}});

      // Collin Soper Theta and Phi
      histosMCreco.add("MCreco_CS_phi_pair_1", "#phi Distribution; #phi; Events", kTH1F, {{nBinsPhi, -3.2, 3.2}});
      histosMCreco.add("MCreco_CS_phi_pair_2", "#phi Distribution; #phi; Events", kTH1F, {{nBinsPhi, -3.2, 3.2}});
      histosMCreco.add("MCreco_CS_costheta_pair_1", "#theta Distribution;cos(#theta); Events", kTH1F, {{nBinsCosTheta, -1, 1}});
      histosMCreco.add("MCreco_CS_costheta_pair_2", "#theta Distribution;cos(#theta); Events", kTH1F, {{nBinsCosTheta, -1, 1}});
    }
  ...
  void processData(UDCollisionFull const& collision, UDtracksfull const& tracks)
  {
    ...
    for (int i = 0; i < numTracksWTSandPIDpi; i++) {
      ...
      histosData.fill(HIST("tpcNSigmaPi_WTS_PID_Pi_Ka"), WTS_PID_Pi_tracks[i].tpcNSigmaKa());
      histosData.fill(HIST("tpcNSigmaPi_WTS_PID_Pi_Pr"), WTS_PID_Pi_tracks[i].tpcNSigmaPr());
      histosData.fill(HIST("tpcNSigmaPi_WTS_PID_Pi_El"), WTS_PID_Pi_tracks[i].tpcNSigmaEl());
      histosData.fill(HIST("tpcNSigmaPi_WTS_PID_Pi_Mu"), WTS_PID_Pi_tracks[i].tpcNSigmaMu());

      histosData.fill(HIST("tofNSigmaPi_WTS_PID_Pi"), WTS_PID_Pi_tracks[i].tofNSigmaPi());
      histosData.fill(HIST("tofNSigmaPi_WTS_PID_Pi_Ka"), WTS_PID_Pi_tracks[i].tofNSigmaKa());
      histosData.fill(HIST("tofNSigmaPi_WTS_PID_Pi_Pr"), WTS_PID_Pi_tracks[i].tofNSigmaPr());
      histosData.fill(HIST("tofNSigmaPi_WTS_PID_Pi_El"), WTS_PID_Pi_tracks[i].tofNSigmaEl());
      histosData.fill(HIST("tofNSigmaPi_WTS_PID_Pi_Mu"), WTS_PID_Pi_tracks[i].tofNSigmaMu());
  ...
  void processMCrec(CollisionTotal const& collision, TrackStuff const& track)
  {
    ...
    std::vector<float> parameters = {pvCut, dcaZcut, dcaXYcut, tpcChi2Cut, tpcNClsFindableCut, itsChi2Cut, etaCut, pTcut};
    int truegapSide = sgSelector.trueGap(collision, fitCuts[0], fitCuts[1], fitCuts[2], zdcCut);
    // histosMCreco.fill(HIST("MCreco_GapSide"), gapSide);
    // histosMCreco.fill(HIST("MCreco_TrueGapSide"), truegapSide);
    // histosMCreco.fill(HIST("MCreco_EventCounts"), 1);
    gapSide = truegapSide;
    ...
    std::vector<decltype(track.begin())> WOTS_tracks;
    std::vector<decltype(track.begin())> WTS_tracks;
    std::vector<decltype(track.begin())> WTS_PID_Pi_tracks;
    std::vector<decltype(track.begin())> Pi_plus_tracks;
    std::vector<decltype(track.begin())> Pi_minus_tracks;

    for (const auto& t0 : track) {
    ...
    if (numPionMinusTRacks == 2 && numPiPlusTracks == 2) {
      ...
      histosMCreco.fill(HIST("MCreco_particle_pT"), p1.Pt());
      histosMCreco.fill(HIST("MCreco_particle_pT"), p2.Pt());
      histosMCreco.fill(HIST("MCreco_particle_pT"), p3.Pt());
      histosMCreco.fill(HIST("MCreco_particle_pT"), p4.Pt());
      ...
      histosMCreco.fill(HIST("MCreco_0charge_4pion_pT"), p1234.Pt());
      histosMCreco.fill(HIST("MCreco_0charge_4pion_rapidity"), p1234.Rapidity());
      histosMCreco.fill(HIST("MCreco_0charge_4pion_invmass"), p1234.M());
      ...
      histosMCreco.fill(HIST("MCreco_CS_phi_pair_1"), phiPair1);
      histosMCreco.fill(HIST("MCreco_CS_phi_pair_2"), phiPair2);
      histosMCreco.fill(HIST("MCreco_CS_costheta_pair_1"), cosThetaPair1);
      histosMCreco.fill(HIST("MCreco_CS_costheta_pair_2"), cosThetaPair2);
    ...
    if (numPionMinusTRacks != 2 || numPiPlusTracks != 2) {
      ...
      histosMCreco.fill(HIST("MCreco_non0charge_4pion_pT"), p1234.Pt());
      histosMCreco.fill(HIST("MCreco_non0charge_4pion_rapidity"), p1234.Rapidity());
      histosMCreco.fill(HIST("MCreco_non0charge_4pion_invmass"), p1234.M());
