...
if(an&&cn){
    ...
    for (auto track : dgtracks) {
      ...
      if (dgcand.gapSide() == 0 ) registry.get<TH1>(HIST("tracks/etaA"))->Fill(vtrk.Eta(), 1.);
      if (dgcand.gapSide() == 1 ) registry.get<TH1>(HIST("tracks/etaC"))->Fill(vtrk.Eta(), 1.);
      if (dgcand.gapSide() == 2 ) registry.get<TH1>(HIST("tracks/etaAC"))->Fill(vtrk.Eta(), 1.);
