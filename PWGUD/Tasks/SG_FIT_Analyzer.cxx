...
//    if (truegapSide == 0) {
    ...
    if (truegapSide == 0) 	    registry.get<TH2>(HIST("FIT/TTFT0"))->Fill(dgcand.timeFT0A(), dgcand.timeFT0C());
    if (truegapSide == 1) 	    registry.get<TH2>(HIST("FIT/TTFT01"))->Fill(dgcand.timeFT0A(), dgcand.timeFT0C());
    if (truegapSide == 2) 	    registry.get<TH2>(HIST("FIT/TTFT02"))->Fill(dgcand.timeFT0A(), dgcand.timeFT0C());
    if (truegapSide == 0) 
...
if(an&&cn){
    ...
    for (auto track : dgtracks) {
      ...
      if (truegapSide == 0 ) registry.get<TH1>(HIST("tracks/etaA"))->Fill(vtrk.Eta(), 1.);
      if (truegapSide == 1 ) registry.get<TH1>(HIST("tracks/etaC"))->Fill(vtrk.Eta(), 1.);
      if (truegapSide == 2 ) registry.get<TH1>(HIST("tracks/etaAC"))->Fill(vtrk.Eta(), 1.);
      ...
      if (truegapSide == 0) registry.get<TH2>(HIST("tracks/etavsptA"))->Fill(vtrk.Eta(), track.pt(), 1.);
      if (truegapSide == 1) registry.get<TH2>(HIST("tracks/etavsptC"))->Fill(vtrk.Eta(), track.pt(), 1.);
      if (truegapSide == 2) registry.get<TH2>(HIST("tracks/etavsptAC"))->Fill(vtrk.Eta(), track.pt(), 1.);
...
if (tof){
    if (truegapSide == 0) 	    registry.get<TH1>(HIST("FIT/tAFT0C"))->Fill(dgcand.totalFT0AmplitudeC(), 1.);
    if (truegapSide == 1) 	    registry.get<TH1>(HIST("FIT/tCFT0A"))->Fill(dgcand.totalFT0AmplitudeA(), 1.);
