...
struct SGExclOmega {
  ...
  void process(UDCollisionFull const& collision, udtracksfull const& tracks)
  {
    ...
    for (auto& [t0, t1, t2, t3, t4, t5] : combinations(tracks, tracks, tracks, tracks, tracks, tracks)) {
      ...
      if (!trackselector(t2, parameters)||!trackselector(t3,parameters))continue;
      if (!trackselector(t4, parameters)||!trackselector(t5,parameters))continue;
	...
	if (selectionPIDPion(t0, use_tof, nsigmatpc_cut, nsigmatof_cut) && selectionPIDPion(t1, use_tof, nsigmatpc_cut, nsigmatof_cut)
		&& selectionPIDElec(t2, use_tof, nsigmatpc_cut, nsigmatof_cut) && selectionPIDElec(t3, use_tof, nsigmatpc_cut, nsigmatof_cut)
		&& selectionPIDElec(t4, use_tof, nsigmatpc_cut, nsigmatof_cut) && selectionPIDElec(t5, use_tof, nsigmatpc_cut, nsigmatof_cut)){
        if (sign == 0) {
