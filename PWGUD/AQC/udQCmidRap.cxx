                     ...
                     aod::Zdcs& zdcs )
    {
      ...
      registry.get<TH1>(HIST("collisions/globalTracks"))->Fill(goodTracks.size());
        ...
        if (ispipiCand) {
                    ...
                    if(netCharge==0)registry.get<TH1>(HIST("DG/hMassAll"))->Fill(ivm.M());
                }
            }//coll
        }//dgcand
       ...
       /* if (doCleanFITBC) {
          for (auto const& bc : bcSlice) {
            ...
            if (isDGcandidate) {
                ...
                registry.get<TH2>(HIST("DG/etaphi1"))->Fill(ivm.Eta(), ivm.Phi());
                        if((ivm.Pt()<0.2) && (netCharge==0)) {registry.get<TH1>(HIST("DG/hMassFIT"))->Fill(ivm.M());}
                    }
        ...
        registry.get<TH1>(HIST("collisions/Stat"))->Fill(2., isZDCcandidate * 1.);
            ...
            if (isZDCcandidate) {
                    if (ispipiCand) {
                        ...
                        if((ivm.Pt()<0.2) && (netCharge==0)) {registry.get<TH1>(HIST("DG/hMassZDC"))->Fill(ivm.M());}
                    }
            ...
            if (isDGcandidate) {
                if (ispipiCand) {
                        ...
                        if((ivm.Pt()<0.2) && (netCharge==0)) {registry.get<TH1>(HIST("DG/hMassFWD"))->Fill(ivm.M());}
                    }
            }
            ...
            if (globalAndVtx) {
                    if (ispipiCand) {
                        ...
                        if((ivm.Pt()<0.2) && (netCharge==0)) {registry.get<TH1>(HIST("DG/hMassGlobalTrk"))->Fill(ivm.M());}
                    }
            }
        ...
        if (ITSOnlytrks) {
                if (ispipiCand) {
                    ...
                    if((ivm.Pt()<0.2) && (netCharge==0)) {registry.get<TH1>(HIST("DG/hMassITSTrk"))->Fill(ivm.M());}
                }
           }
          ...
          // 6. check a given bc for possible ambiguous Tracks
            ...
            if (noAmbTracks) {
                    if (ispipiCand) {
                        ...
                        if((ivm.Pt()<0.2) && (netCharge==0)) {registry.get<TH1>(HIST("DG/hMassAmbigous"))->Fill(ivm.M());}
                    }
            }
            ...
            if (noAmbFwdTracks) {
                    if (ispipiCand) {
                        ...
                        if((ivm.Pt()<0.2) && (netCharge==0)) {registry.get<TH1>(HIST("DG/hMassAmbigousFWD"))->Fill(ivm.M());}
                    }
            }
            ...
            if (isDGcandidate) {
                    if (ispipiCand) {
                        ...
                        if((ivm.Pt()<0.2) && (netCharge==0)) {registry.get<TH1>(HIST("DG/hMassTOF"))->Fill(ivm.M());}
                    }
