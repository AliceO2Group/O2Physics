...
struct pidTOFTaskBeta {
  using Trks = soa::Join<aod::Tracks, aod::TracksExtra, aod::TrkTOFSignal>;
...
struct tofPidQaBeta {
  ...
  void process(soa::Join<aod::Tracks, aod::TracksExtra, aod::TracksCov, aod::pidTOFbeta, aod::TrackSelection, aod::TrkTOFSignal> const& tracks,
