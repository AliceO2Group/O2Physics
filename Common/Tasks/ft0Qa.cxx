...
struct ft0QaTask
{
  ...
  void init(InitContext &)
  {
    ...
    histos.add("hBcT0ACdiff", "(T0A -T0C)/2;(T0A -T0C)/2 (ns);counts", kTH1F, {axisColTimeRes});
    ...
    histos.add("hBcT0ACTVX", "T0AC TVX;T0AC time (ns);counts", kTH1F, {axisTime});
    histos.add("hBcT0ACdiffTVX", "(T0A -T0C)/2;(T0A -T0C)/2 (ns);counts", kTH1F, {axisColTimeRes});

    // FT0 amplitude and multiplicity
    histos.add("hBcAmpT0A", "amplitude T0A;#ADC channels;counts", kTH1F, {axisAmpT0A});
    histos.add("hBcAmpT0C", "amplitude T0C;#ADC channels;counts", kTH1F, {axisAmpT0C});

    histos.add("hBcMultT0A", ";(# ADC channels);counts", kTH1F, {axisMultT0A});
    histos.add("hBcMultT0AOrA", "OrA trig;(# ADC channels);counts", kTH1F, {axisMultT0A});
    histos.add("hBcMultT0ATVX", "TVX trig;(# ADC channels);counts", kTH1F, {axisMultT0A});
    histos.add("hBcMultT0AOrAC", "OrA && OrC trig;(# ADC channels);counts", kTH1F, {axisMultT0A});
    histos.add("hBcMultT0ACent", "Central trig;(# ADC channels);counts", kTH1F, {axisMultT0A});
    histos.add("hBcMultT0ASCent", "SemiCentral trig;(# ADC channels);counts", kTH1F, {axisMultT0A});

    histos.add("hBcMultT0C", ";(# ADC channels);counts", kTH1F, {axisMultT0C});
    histos.add("hBcMultT0COrC", "OrC trig;(# ADC channels);counts", kTH1F, {axisMultT0C});
    histos.add("hBcMultT0CTVX", "TVX trig;(# ADC channels);counts", kTH1F, {axisMultT0C});
    histos.add("hBcMultT0COrAC", "OrA && OrC trig;(# ADC channels);counts", kTH1F, {axisMultT0C});
    histos.add("hBcMultT0CCent", "Central trig;(# ADC channels);counts", kTH1F, {axisMultT0C});
    histos.add("hBcMultT0CSCent", "SemiCentral trig;(# ADC channels);counts", kTH1F, {axisMultT0C});

    histos.add("hBcMultT0AC", ";(# ADC channels);counts", kTH1F, {axisMultT0AC});
    histos.add("hBcMultT0ACTVX", "TVX trig;(# ADC channels);counts", kTH1F, {axisMultT0AC});
    histos.add("hBcMultT0ACOrAC", "OrA && OrC trig;(# ADC channels);counts", kTH1F, {axisMultT0AC});
    histos.add("hBcMultT0ACCent", "Central trig;(# ADC channels);counts", kTH1F, {axisMultT0AC});
    histos.add("hBcMultT0ACSCent", "SemiCentral trig;(# ADC channels);counts", kTH1F, {axisMultT0AC});
  }

  void processCollisions(soa::Join<aod::Collisions,
                                   aod::EvSels, aod::Mults, aod::FT0sCorrected>::iterator const &collision,
  ...
  // soa::Join<aod::BCs, aod::BcSels, aod::Mults >::iterator const &collision, aod::FT0s const &ft0s, aod::FV0As const &fv0s
