...
DECLARE_SOA_COLUMN(CentFT0A, centFT0A, float);                         //! Run3 centrality percentile estimated from FT0A+FT0C multiplicities
DECLARE_SOA_COLUMN(CentFT0C, centFT0C, float);                         //! Run3 centrality percentile estimated from FT0A+FT0C multiplicities
...
DECLARE_SOA_TABLE(CentFT0As, "AOD", "CENTFT0A", cent::CentFT0A);                         //! Run3 FT0M estimated centrality table
DECLARE_SOA_TABLE(CentFT0Cs, "AOD", "CENTFT0C", cent::CentFT0C);                         //! Run3 FT0M estimated centrality table
