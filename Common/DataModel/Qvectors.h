...
DECLARE_SOA_COLUMN(QvecFT0CRe, qvecFT0CRe, std::vector<float>);
DECLARE_SOA_COLUMN(QvecFT0CIm, qvecFT0CIm, std::vector<float>);
DECLARE_SOA_COLUMN(QvecFT0ARe, qvecFT0ARe, std::vector<float>);
DECLARE_SOA_COLUMN(QvecFT0AIm, qvecFT0AIm, std::vector<float>);
DECLARE_SOA_COLUMN(QvecFT0MRe, qvecFT0MRe, std::vector<float>);
DECLARE_SOA_COLUMN(QvecFT0MIm, qvecFT0MIm, std::vector<float>);
DECLARE_SOA_COLUMN(QvecFV0ARe, qvecFV0ARe, std::vector<float>);
DECLARE_SOA_COLUMN(QvecFV0AIm, qvecFV0AIm, std::vector<float>);
DECLARE_SOA_COLUMN(QvecBPosRe, qvecBPosRe, std::vector<float>);
DECLARE_SOA_COLUMN(QvecBPosIm, qvecBPosIm, std::vector<float>);
DECLARE_SOA_COLUMN(QvecBNegRe, qvecBNegRe, std::vector<float>);
DECLARE_SOA_COLUMN(QvecBNegIm, qvecBNegIm, std::vector<float>);
