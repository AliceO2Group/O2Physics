...
DECLARE_SOA_COLUMN(PassedDCAzFB1, passedDCAzFB1, bool);                               //! Passed the track cut: kDCAz defined for FB1
  DECLARE_SOA_COLUMN(QuestoTest, questoTest, bool);                           //! Passed the track cut: kTrackType
// Combo selections
