...
template <o2::soa::is_table TEMPrimaryElectronsFromDalitz, o2::soa::is_table TEMPrimaryElectronsDeDxMC>
struct skimmerPrimaryElectronFromDalitzEE {
  ...
  Preslice<o2::aod::V0PhotonsKF> perCol_pcm = o2::aod::v0photonkf::collisionId;
  ...
  // ---------- for data ----------
  void processRec(MyCollisions const& collisions, MyBCs const& bcs, MyTracks const& tracks, o2::aod::V0PhotonsKF const& v0photons, o2::aod::TrackAssoc const& trackIndices)
  {
  ...
  // ---------- for MC ----------
  void processMC(MyCollisionsMC const& collisions, o2::aod::McCollisions const&, MyBCs const& bcs, MyTracksMC const& tracks, o2::aod::V0PhotonsKF const& v0photons, o2::aod::TrackAssoc const& trackIndices, o2::aod::McParticles const&)
  {
