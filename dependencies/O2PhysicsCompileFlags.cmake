...
if(O2PHYSICS_WARNINGS_AS_ERRORS)
  # Add warnings for both GCC and Clang.
  ...
  if(APPLE)
    ...
    o2_build_warning_flags(PREFIX "-Werror="
                           ...
                           WARNINGS ${O2PHYSICS_WARNINGS_APPLE})
  ...
  elseif(UNIX)
    ...
    o2_build_warning_flags(PREFIX "-Werror="
                           ...
                           WARNINGS ${O2PHYSICS_WARNINGS_UNIX})
