...
-Werror=c++0x-compat \
-Werror=c++0x-extensions \
-Werror=c++0x-narrowing \
-Werror=c++11-compat-deprecated-writable-strings \
-Werror=c++11-compat-pedantic \
-Werror=c++11-inline-namespace \
-Werror=c++11-narrowing \
-Werror=c++17-compat-mangling \
-Werror=c++17-compat-pedantic \
-Werror=c++1y-extensions \
-Werror=c++1z-compat \
-Werror=c++1z-compat-mangling \
-Werror=c++1z-extensions \
-Werror=c++20-compat-pedantic \
-Werror=c++2a-compat \
-Werror=c++2a-compat-pedantic \
-Werror=c++2a-extensions \
-Werror=c++2b-extensions \
