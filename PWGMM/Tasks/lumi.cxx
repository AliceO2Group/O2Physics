...
struct lumiTask{
		...
		histos.add("vertexx_timestamp", "", HistType::kTH2F,{{1000,-1,1,"x"},{1000,0,5e7,"t"}});
		histos.add("vertexy_timestamp", "", HistType::kTH2F,{{1000,-1,1,"y"},{1000,0,5e7,"t"}});
	} // init
...
//		LOGF(info, "Got timestamp %llu", bc.timestamp());
		histos.fill(HIST("vertexx_timestamp"), collision.posX(), bc.timestamp()-1530314294062 );
		histos.fill(HIST("vertexy_timestamp"), collision.posY(), bc.timestamp()-1530314294062 );
