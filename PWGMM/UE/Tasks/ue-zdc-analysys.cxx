...
struct ZDCAnalysis {
  ...
  void init(InitContext const&)
  {
    if (doprocessZdcAuto) { // Check if the process function for ZDCAuto is enabled
      ...
      registry.add("ZNvsZEM", "ZNvsZEM", {HistType::kTH2F, {{{nBins2, -10., MaxZP}, {nBins2, -10., MaxZN}}}});
      ...
      //
      registry.add("ZNCadcvstdc", "ZNCadcvstdc", {HistType::kTH2F, {{{100, -25., 25.}, {nBins1, -10., MaxZN}}}});
      registry.add("ZNAadcvstdc", "ZNAadcvstdc", {HistType::kTH2F, {{{100, -25., 25.}, {nBins1, -10., MaxZN}}}});
      registry.add("ZPCadcvstdc", "ZPCadcvstdc", {HistType::kTH2F, {{{100, -25., 25.}, {nBins1, -10., MaxZP}}}});
      registry.add("ZPAadcvstdc", "ZPAadcvstdc", {HistType::kTH2F, {{{100, -25., 25.}, {nBins1, -10., MaxZP}}}});
      registry.add("ZEM1adcvstdc", "ZEM1adcvstdc", {HistType::kTH2F, {{{100, -25., 25.}, {nBins1, -10., MaxZP}}}});
      registry.add("ZEM2adcvstdc", "ZEM2adcvstdc", {HistType::kTH2F, {{{100, -25., 25.}, {nBins1, -10., MaxZP}}}});
    }
    if (doprocessZdcBcAss) { // Check if the process function for ZDCBcAss is enabled
      ...
      registry.add("ZNvsZEMbc", "ZNvsZEMbc", {HistType::kTH2F, {{{nBins2, -10., MaxZP}, {nBins2, -10., MaxZN}}}});
    ...
    if (doprocessZdcCollAss) { // Check if the process function for ZDCCollAss is enabled
      ...
      registry.add("ZNvsZEMcoll", "ZNvsZEMcoll", {HistType::kTH2F, {{{nBins2, -10., MaxZP}, {nBins2, -10., MaxZN}}}});
      ...
      //
      registry.add("ZNCadcvstdccoll", "ZNCadcvstdccoll", {HistType::kTH2F, {{{100, -25., 25.}, {nBins1, -10., MaxZN}}}});
      registry.add("ZNAadcvstdccoll", "ZNAadcvstdccoll", {HistType::kTH2F, {{{100, -25., 25.}, {nBins1, -10., MaxZN}}}});
      registry.add("ZPCadcvstdccoll", "ZPCadcvstdccoll", {HistType::kTH2F, {{{100, -25., 25.}, {nBins1, -10., MaxZP}}}});
      registry.add("ZPAadcvstdccoll", "ZPAadcvstdccoll", {HistType::kTH2F, {{{100, -25., 25.}, {nBins1, -10., MaxZP}}}});
      registry.add("ZEM1adcvstdccoll", "ZEM1adcvstdccoll", {HistType::kTH2F, {{{100, -25., 25.}, {nBins1, -10., MaxZP}}}});
      registry.add("ZEM2adcvstdccoll", "ZEM2adcvstdccoll", {HistType::kTH2F, {{{100, -25., 25.}, {nBins1, -10., MaxZP}}}});
    }
  ...
  void processZdcAuto(aod::Zdc const& zdc)
  {
    ...
    registry.get<TH2>(HIST("ZPAcvsZPAsum"))->Fill(zdc.energyCommonZPA(), sumZPA);
    //
