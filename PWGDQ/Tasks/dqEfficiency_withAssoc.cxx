...
void DefineHistograms(HistogramManager* histMan, TString histClasses, const char* histGroups)
{
  ...
  for (Int_t iclass = 0; iclass < objArray->GetEntries(); ++iclass) {
    ...
    if (classStr.Contains("MCTruthGen")) {
      ...
      histMan->AddHistogram(objArray->At(iclass)->GetName(), "Pt_Rapidity", "MC generator p_{T}, y distribution", false, 120, 0.0, 30.0, VarManager::kMCPt, 1000, -5.0, 5.0, VarManager::kMCY);
    }
