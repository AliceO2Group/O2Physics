...
void DefineHistograms(HistogramManager* histMan, TString histClasses)
{
  ...
  for (Int_t iclass = 0; iclass < objArray->GetEntries(); ++iclass) {
    ...
    if (classStr.Contains("MCTruthGenPair")) {
      ...
      histMan->AddHistogram(objArray->At(iclass)->GetName(), "cosTheta_Phi", "MC generator cosTheta, phi distribution", false, 40, -1.0, 1.0, VarManager::kMCCosThetaHE, 40, -3.14, 3.14, VarManager::kMCPhiHE);
