...
struct taskMuonMchTrkEfficiency {
    ...
    void init(o2::framework::InitContext&)
    {
        ...
        for(int i=0; i<16; i++)  hHitsEtaPtPhi->GetAxis(0)->SetBinLabel(i+1,elabels[i]);
    ...
    void FillHistos(double eta, double pt, double phi, uint16_t map)
    {
        ...
        if(  iN[0]  &&   iN[1] ) registry.get<THn>(HIST("hHitsEtaPtPhi"))->Fill(0.,eta,pt,phi);
        if(  iN[0]  && (!iN[1])) registry.get<THn>(HIST("hHitsEtaPtPhi"))->Fill(1.,eta,pt,phi);
        if((!iN[0]) &&   iN[1] ) registry.get<THn>(HIST("hHitsEtaPtPhi"))->Fill(2.,eta,pt,phi);
        if(  iN[2]  &&   iN[3] ) registry.get<THn>(HIST("hHitsEtaPtPhi"))->Fill(3.,eta,pt,phi);
        if(  iN[2]  && (!iN[3])) registry.get<THn>(HIST("hHitsEtaPtPhi"))->Fill(4.,eta,pt,phi);
        if((!iN[2]) &&   iN[3] ) registry.get<THn>(HIST("hHitsEtaPtPhi"))->Fill(5.,eta,pt,phi);
        if(  iN[4]  &&   iN[5] ) registry.get<THn>(HIST("hHitsEtaPtPhi"))->Fill(6.,eta,pt,phi);
        if(  iN[4]  && (!iN[5])) registry.get<THn>(HIST("hHitsEtaPtPhi"))->Fill(7.,eta,pt,phi);
        if((!iN[4]) &&   iN[5] ) registry.get<THn>(HIST("hHitsEtaPtPhi"))->Fill(8.,eta,pt,phi);
        if(  iN[6]  &&   iN[7] ) registry.get<THn>(HIST("hHitsEtaPtPhi"))->Fill(9.,eta,pt,phi);
        if(  iN[6]  && (!iN[7])) registry.get<THn>(HIST("hHitsEtaPtPhi"))->Fill(10.,eta,pt,phi);
        if((!iN[6]) &&   iN[7] ) registry.get<THn>(HIST("hHitsEtaPtPhi"))->Fill(11.,eta,pt,phi);
        if(  iN[8]  &&   iN[9] ) registry.get<THn>(HIST("hHitsEtaPtPhi"))->Fill(12.,eta,pt,phi);
        if(  iN[8]  && (!iN[9])) registry.get<THn>(HIST("hHitsEtaPtPhi"))->Fill(13.,eta,pt,phi);
        if((!iN[8]) &&   iN[9] ) registry.get<THn>(HIST("hHitsEtaPtPhi"))->Fill(14.,eta,pt,phi);
    }
