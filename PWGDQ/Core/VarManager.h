...
class VarManager : public TObject
{
 ...
 public:
  ...
  static void SetupTwoProngKFParticle(float magField)
  {
    ...
    fgUsedKF = true;
    LOG(info) << "~~~~~~~~~~~~~~~~ It is using KFParticle !!!!!!!!!!!!!!!!!!!" << " with fgUsedKF: "<< fgUsedKF;
  }
