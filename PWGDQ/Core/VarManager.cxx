...
void VarManager::SetDefaultVarNames()
{
  ...
  fgVariableNames[kQ21XAPOS] = "Q_{20,x}^{APOS} ";
  fgVariableUnits[kQ21XAPOS] = "";
  fgVariableNames[kQ21YAPOS] = "Q_{20,y}^{APOS} ";
  fgVariableUnits[kQ21YAPOS] = "";
  fgVariableNames[kQ21XANEG] = "Q_{20,x}^{ANEG} ";
  fgVariableUnits[kQ21XANEG] = "";
  fgVariableNames[kQ21YANEG] = "Q_{20,y}^{ANEG} ";
  fgVariableUnits[kQ21YANEG] = "";
  fgVariableNames[kQ11XA] = "Q_{11,x}^{A} ";
  fgVariableUnits[kQ11XA] = "";
  fgVariableNames[kQ11YA] = "Q_{11,y}^{A} ";
  fgVariableUnits[kQ11YA] = "";
  fgVariableNames[kQ11XB] = "Q_{11,x}^{B} ";
  fgVariableUnits[kQ11XB] = "";
  fgVariableNames[kQ11YB] = "Q_{11,y}^{B} ";
  fgVariableUnits[kQ11YB] = "";
  fgVariableNames[kQ11XC] = "Q_{11,x}^{C} ";
  fgVariableUnits[kQ11XC] = "";
  fgVariableNames[kQ11YC] = "Q_{11,y}^{C} ";
  fgVariableUnits[kQ11YC] = "";
  fgVariableNames[kQ21XA] = "Q_{21,x}^{A} ";
  fgVariableUnits[kQ21XA] = "";
  fgVariableNames[kQ21YA] = "Q_{21,y}^{A} ";
  fgVariableUnits[kQ21YA] = "";
  fgVariableNames[kQ21XB] = "Q_{21,x}^{B} ";
  fgVariableUnits[kQ21XB] = "";
  fgVariableNames[kQ21YB] = "Q_{21,y}^{B} ";
  fgVariableUnits[kQ21YB] = "";
  fgVariableNames[kQ21XC] = "Q_{21,x}^{C} ";
  fgVariableUnits[kQ21XC] = "";
  fgVariableNames[kQ21YC] = "Q_{21,y}^{C} ";
  fgVariableUnits[kQ21YC] = "";
  ...
  fgVariableNames[kQ31XA] = "Q_{31,x}^{A} ";
  fgVariableUnits[kQ31XA] = "";
  fgVariableNames[kQ31YA] = "Q_{31,y}^{A} ";
  fgVariableUnits[kQ31YA] = "";
  fgVariableNames[kQ31XB] = "Q_{31,x}^{B} ";
  fgVariableUnits[kQ31XB] = "";
  fgVariableNames[kQ31YB] = "Q_{31,y}^{B} ";
  fgVariableUnits[kQ31YB] = "";
  fgVariableNames[kQ31XC] = "Q_{31,x}^{C} ";
  fgVariableUnits[kQ31XC] = "";
  fgVariableNames[kQ31YC] = "Q_{31,y}^{C} ";
  fgVariableUnits[kQ31YC] = "";
  fgVariableNames[kQ41XA] = "Q_{41,x}^{A} ";
  fgVariableUnits[kQ41XA] = "";
  fgVariableNames[kQ41YA] = "Q_{41,y}^{A} ";
  fgVariableUnits[kQ41YA] = "";
  fgVariableNames[kQ41XB] = "Q_{41,x}^{B} ";
  fgVariableUnits[kQ41XB] = "";
  fgVariableNames[kQ41YB] = "Q_{41,y}^{B} ";
  fgVariableUnits[kQ41YB] = "";
  fgVariableNames[kQ41XC] = "Q_{41,x}^{C} ";
  fgVariableUnits[kQ41XC] = "";
  fgVariableNames[kQ41YC] = "Q_{41,y}^{C} ";
  fgVariableUnits[kQ41YC] = "";
