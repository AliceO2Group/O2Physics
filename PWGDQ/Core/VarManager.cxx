...
void VarManager::SetDefaultVarNames()
{
  ...
  fgVariableNames[kEMCalEnergy] = "cluster energy (GeV)";
  fgVariableUnits[kEMCalEnergy] = "GeV";
  fgVariableNames[kEMCalCoreEnergy] = "cluster core energy (GeV)";
  fgVariableUnits[kEMCalCoreEnergy] = "GeV";
  fgVariableNames[kEMCalRawEnergy] = "raw cluster energy (GeV)";
  fgVariableUnits[kEMCalRawEnergy] = "GeV";
  fgVariableNames[kEMCalEta] = "cluster pseudorapidity";
  fgVariableUnits[kEMCalEta] = "";
  fgVariableNames[kEMCalPhi] = "cluster azimuthal angle";
  fgVariableUnits[kEMCalPhi] = "#varphi";
  fgVariableNames[kEMCalM02] = "shower shape long axis";
  fgVariableUnits[kEMCalM02] = "";
  fgVariableNames[kEMCalM20] = "shower shape short axis";
  fgVariableUnits[kEMCalM20] = "";
  fgVariableNames[kEMCalNCells] = "number of cells in cluster";
  fgVariableUnits[kEMCalNCells] = "";
  fgVariableNames[kEMCalTime] = "cluster time (ns)";
  fgVariableUnits[kEMCalTime] = "ns";
  fgVariableNames[kEMCalIsExotic] = "flag to mark cluster as exotic";
  fgVariableUnits[kEMCalIsExotic] = "";
  fgVariableNames[kEMCalDistanceToBadChannel] = "distance to bad channel";
  fgVariableUnits[kEMCalDistanceToBadChannel] = "";
  fgVariableNames[kEMCalNLM] = "number of local maxima";
  fgVariableUnits[kEMCalNLM] = "";
  fgVariableNames[kEMCalDefinition] = "cluster definition";
