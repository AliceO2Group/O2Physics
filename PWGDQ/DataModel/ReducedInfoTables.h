...
DECLARE_SOA_COLUMN(Q11XA, q11xa, float);       //!  Q-vector x component, with event eta gap A (harmonic 1 and power 1)
DECLARE_SOA_COLUMN(Q11YA, q11ya, float);       //!  Q-vector y component, with event eta gap A (harmonic 1 and power 1)
DECLARE_SOA_COLUMN(Q11XB, q11xb, float);       //!  Q-vector x component, with event eta gap B (harmonic 1 and power 1)
DECLARE_SOA_COLUMN(Q11YB, q11yb, float);       //!  Q-vector y component, with event eta gap B (harmonic 1 and power 1)
DECLARE_SOA_COLUMN(Q11XC, q11xc, float);       //!  Q-vector x component, with event eta gap C (harmonic 1 and power 1)
DECLARE_SOA_COLUMN(Q11YC, q11yc, float);       //!  Q-vector y component, with event eta gap C (harmonic 1 and power 1)
DECLARE_SOA_COLUMN(Q21XA, q21xa, float);       //!  Q-vector x component, with event eta gap A (harmonic 2 and power 1)
DECLARE_SOA_COLUMN(Q21YA, q21ya, float);       //!  Q-vector y component, with event eta gap A (harmonic 2 and power 1)
DECLARE_SOA_COLUMN(Q21XB, q21xb, float);       //!  Q-vector x component, with event eta gap B (harmonic 2 and power 1)
DECLARE_SOA_COLUMN(Q21YB, q21yb, float);       //!  Q-vector y component, with event eta gap B (harmonic 2 and power 1)
DECLARE_SOA_COLUMN(Q21XC, q21xc, float);       //!  Q-vector x component, with event eta gap C (harmonic 2 and power 1)
DECLARE_SOA_COLUMN(Q21YC, q21yc, float);       //!  Q-vector y component, with event eta gap C (harmonic 2 and power 1)
...
DECLARE_SOA_COLUMN(Q31XA, q31xa, float);       //!  Q-vector x component, with event eta gap A (harmonic 3 and power 1)
DECLARE_SOA_COLUMN(Q31YA, q31ya, float);       //!  Q-vector y component, with event eta gap A (harmonic 3 and power 1)
DECLARE_SOA_COLUMN(Q31XB, q31xb, float);       //!  Q-vector x component, with event eta gap B (harmonic 3 and power 1)
DECLARE_SOA_COLUMN(Q31YB, q31yb, float);       //!  Q-vector y component, with event eta gap B (harmonic 3 and power 1)
DECLARE_SOA_COLUMN(Q31XC, q31xc, float);       //!  Q-vector x component, with event eta gap C (harmonic 3 and power 1)
DECLARE_SOA_COLUMN(Q31YC, q31yc, float);       //!  Q-vector y component, with event eta gap C (harmonic 3 and power 1)
DECLARE_SOA_COLUMN(Q41XA, q41xa, float);       //!  Q-vector x component, with event eta gap A (harmonic 4 and power 1)
DECLARE_SOA_COLUMN(Q41YA, q41ya, float);       //!  Q-vector y component, with event eta gap A (harmonic 4 and power 1)
DECLARE_SOA_COLUMN(Q41XB, q41xb, float);       //!  Q-vector x component, with event eta gap B (harmonic 4 and power 1)
DECLARE_SOA_COLUMN(Q41YB, q41yb, float);       //!  Q-vector y component, with event eta gap B (harmonic 4 and power 1)
DECLARE_SOA_COLUMN(Q41XC, q41xc, float);       //!  Q-vector x component, with event eta gap C (harmonic 4 and power 1)
DECLARE_SOA_COLUMN(Q41YC, q41yc, float);       //!  Q-vector y component, with event eta gap C (harmonic 4 and power 1)
...
DECLARE_SOA_TABLE(ReducedEventsQvector, "AOD", "REQVECTOR", //!    Event Q-vector information
                  reducedevent::Q11XA, reducedevent::Q11YA, reducedevent::Q11XB, reducedevent::Q11YB, reducedevent::Q11XC, reducedevent::Q11YC,
                  reducedevent::Q21XA, reducedevent::Q21YA, reducedevent::Q21XB, reducedevent::Q21YB, reducedevent::Q21XC, reducedevent::Q21YC,
                  reducedevent::MultA, reducedevent::MultB, reducedevent::MultC,
                  reducedevent::Q31XA, reducedevent::Q31YA, reducedevent::Q31XB, reducedevent::Q31YB, reducedevent::Q31XC, reducedevent::Q31YC,
                  reducedevent::Q41XA, reducedevent::Q41YA, reducedevent::Q41XB, reducedevent::Q41YB, reducedevent::Q41XC, reducedevent::Q41YC,
