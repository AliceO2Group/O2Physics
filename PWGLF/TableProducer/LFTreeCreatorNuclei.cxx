...
struct LfTreeCreatorNuclei {
        ...
        for (auto &track : tracks) {
            ...
            if constexpr (isMC) { // Filling MC reco information
                if (track.has_mcParticle()) {
                    ...
                    //std::cout<<"Physical primary=========>"<<particle.isPhysicalPrimary()<<std::endl;
                    continue;
                }
    ...
    PROCESS_SWITCH(LfTreeCreatorNuclei, processData,
    "process Data", true);
    ...
    PROCESS_SWITCH(LfTreeCreatorNuclei, processMC,
    "process MC", false);
};
