...
struct f1protoninitializer {
  ...
  /////////////////////////////////////////////////////////////
  double massPi = RecoDecay::getMassPDG(kPiPlus);  double massKa = RecoDecay::getMassPDG(kKPlus);  double massK0s = RecoDecay::getMassPDG(kK0Short);
  double massF1{0.}; double  masskKs0{0.}; double pT{0.};
  TLorentzVector F1Vector, ProtonVector, F1ProtonVector, RelativeMomentumVector;
  double betaX=0; double betaY=0; double betaZ=0;
  ...
  //void processF1Proton(aod::Collision const& collision, PrimaryTrackCandidates const& tracks, ResoV0s const& V0s)
  {
    ...
    int numberPion=0; int numberPiKpair=0;  int numberF1=0;  int numberF1Proton=0;  int numberF1ProtonFemto=0;
    bool triggerF1=false; bool triggerF1Proton=false;  bool triggerF1ProtonFemto=false;
