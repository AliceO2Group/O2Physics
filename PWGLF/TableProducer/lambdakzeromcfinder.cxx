...
struct lambdakzeromcfinder {
  ...
  Configurable<float> etaMax{"etaMax", 0.9, "broad daughter eta pre-filter for speed"};
  ...
  Partition<LabeledTracks> posTracks = aod::track::signed1Pt > 0.0f && (aod::track::eta < etaMax) && (aod::track::eta > etaMax);
  Partition<LabeledTracks> negTracks = aod::track::signed1Pt < 0.0f && (aod::track::eta < etaMax) && (aod::track::eta > etaMax);
