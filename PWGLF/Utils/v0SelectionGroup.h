...
class v0SelectionGroup
{
 public:
  v0SelectionGroup()
    : rapidityCut{0.5f}, daughterEtaCut{0.8f}, v0cospa{0.97f}, dcav0dau{1.0f},
    dcanegtopv{0.05f}, dcapostopv{0.05f}, v0radius{1.2f}, v0radiusMax{1.2f}, 
    minTPCrows{70}, minITSclusters{-1}, skipTPConly{false}, requirePosITSonly{false}, 
    requireNegITSonly{false}, TpcPidNsigmaCut{5.0f}, TofPidNsigmaCutLaPr{1e+6}, 
    TofPidNsigmaCutLaPi{1e+6}, TofPidNsigmaCutK0Pi{1e+6}, 
    maxDeltaTimeProton{1e+9}, maxDeltaTimePion{1e+9}, 
    lifetimeCutK0Short{20.0f}, lifetimeCutLambda{20.0f}, 
    armPodCut{5.0f}
  {
    // constructor
  }
