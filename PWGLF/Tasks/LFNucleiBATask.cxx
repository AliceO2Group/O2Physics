...
struct LFNucleiBATask {
    ...
    void init(o2::framework::InitContext &) {
        ...
        histos.add<TH1>("qa/h1TPCncr", "number of crossed rows in TPC; TPCncr; counts", HistType::kTH1F,
                        {{150, 60, 170}});
        histos.add<TH1>("qa/h1rTPC", "ratio of ncr over findable in TPC; rTPC; counts", HistType::kTH1F,
                        {{200, 0.9, 1.8}});
        histos.add<TH1>("qa/h1chi2ITS", "#chi^{2}_{ITS}/n_{ITS}; #chi^{2}_{ITS}/n_{ITS};counts", HistType::kTH1F,
                        {{51, -0.5, 50.5}});
        histos.add<TH1>("qa/h1chi2TPC", "#chi^{2}_{TPC}/n_{TPC}; #chi^{2}_{TPC}/n_{TPC}; counts", HistType::kTH1F,
                        {{11, -0.5, 10.5}});
        ...
        histos.add<TH2>("tracks/h2EtaVsPhi", "#eta (TOF) vs #phi; #eta; #phi", HistType::kTH2F, {{200, -1.0, 1.0},
                                                                                                 {80,  -0.5, 7.5}});
        histos.add<TH1>("tracks/h1pT", "Track #it{p}_{T}; #it{p}_{T} (GeV/#it{c}); counts", HistType::kTH1F,
                        {{1000, 0., 10}});
        ...
        histos.add<TH2>("tracks/hDCAxyVsDCAz", "DCAxy vs DCAz; DCAxy (cm); DCAz (cm)", HistType::kTH2F,
                        {{200, -2.0, 2.0},
                         {200, -2.0, 2.0}});

        histos.add<TH1>("tracks/proton/h1ProtonSpectra", "#it{p}_{T} (p); #it{p}_{T} (GeV/#it{c}); counts",
                        HistType::kTH1F, {{800, 0, 8}});
        histos.add<TH1>("tracks/deuteron/h1DeuteronSpectra", "#it{p}_{T} (d); #it{p}_{T} (GeV/#it{c}); counts",
                        HistType::kTH1F, {{800, 0, 8}});
        histos.add<TH1>("tracks/helium/h1HeliumSpectra", "#it{p}_{T} (He); #it{p}_{T} (GeV/#it{c}); counts",
                        HistType::kTH1F, {{800, 0, 8}});

        histos.add<TH2>("tracks/h2TPCsignVsTPCmomentum", "-dE/dX vs p; p (GeV/c); -dE/dx (a.u.)", HistType::kTH2F,
                        {{500,   0.0, 5.0},
                         {81000, 0.0, 1E3}});
        histos.add<TH2>("tracks/h2TOFbetaVsP", "#beta (TOF) vs p; p (GeV/c); #beta", HistType::kTH2F, {{500,  0.0, 5.0},
                                                                                                       {1200, 0.0, 1.2}});

        histos.add<TH2>("tracks/pion/h2PionVspNSigmaTPC", "NSigmaTPC(pi) vs p; Momentum(p) in GeV; NSigmaTPC",
                        HistType::kTH2F, {{100, 0,   10.},
                                          {200, -10, 10.}});
        histos.add<TH2>("tracks/kaon/h2KaonVspNSigmaTPC", "NSigmaTPC(Ka) vs p; Momentum(p) in GeV; NSigmaTPC",
                        HistType::kTH2F, {{100, 0,   10.},
                                          {200, -10, 10.}});
        histos.add<TH2>("tracks/proton/h2ProtonVspNSigmaTPC", "NSigmaTPC(proton) vs p; Momentum(p) in GeV; NSigmaTPC",
                        HistType::kTH2F, {{100, 0,   10.},
                                          {200, -10, 10.}});
        histos.add<TH2>("tracks/deuteron/h2DeuteronVspNSigmaTPC", "NSigmaTPC(D) vs p; Momentum(p) in GeV; NSigmaTPC",
                        HistType::kTH2F, {{100, 0,   10.},
                                          {200, -10, 10.}});
        histos.add<TH2>("tracks/helium/h2HeliumVspNSigmaTPC", "NSigmaTPC(He) vs p; Momentum(p) in GeV; NSigmaTPC",
                        HistType::kTH2F, {{100, 0,   10.},
                                          {200, -10, 10.}});
        histos.add<TH2>("tracks/pion/h2PionVspNSigmaTOF", "NSigmaTOF(pi) vs p; Momentum(p) in GeV; NSigmaTOF",
                        HistType::kTH2F, {{100, 0,   10.},
                                          {200, -10, 10.}});
        histos.add<TH2>("tracks/kaon/h2KaonVspNSigmaTOF", "NSigmaTOF(Ka) vs p; Momentum(p) in GeV; NSigmaTOF",
                        HistType::kTH2F, {{100, 0,   10.},
                                          {200, -10, 10.}});
        histos.add<TH2>("tracks/proton/h2ProtonVspNSigmaTOF", "NSigmaTOF(proton) vs p; Momentum(p) in GeV; NSigmaTOF",
                        HistType::kTH2F, {{100, 0,   10.},
                                          {200, -10, 10.}});
        histos.add<TH2>("tracks/deuteron/h2DeuteronVspNSigmaTOF", "NSigmaTOF(D) vs p; Momentum(p) in GeV; NSigmaTOF",
                        HistType::kTH2F, {{100, 0,   10.},
                                          {200, -10, 10.}});
        histos.add<TH2>("tracks/helium/h2HeliumVspNSigmaTOF", "NSigmaTOF(He) vs p; Momentum(p) in GeV; NSigmaTOF",
                        HistType::kTH2F, {{100, 0,   10.},
                                          {200, -10, 10.}});

        // TOF mass histograms
        histos.add<TH2>("tracks/h2TOFmassVsPt", "h2TOFmassVsPt; TOFmass; #it{p}_{T} (GeV)", HistType::kTH2F,
                        {{600, 0., 3.},
                         {500, 0., 5.}});

        // TOF mass squared histograms
        histos.add<TH2>("tracks/proton/h2TOFmass2ProtonVsPt",
                        "#Delta M^{2} (p) vs #it{p}_{T}; #Delta M^{2} (p); #it{p}_{T} (GeV/#it{c})", HistType::kTH2F,
                        {{600, -3., 3.},
                         {800, 0.,  8.}});
        histos.add<TH2>("tracks/deuteron/h2TOFmass2DeuteronVsPt",
                        "#Delta M^{2} (d) vs #it{p}_{T}; #Delta M^{2} (d); #it{p}_{T} (GeV/#it{c})", HistType::kTH2F,
                        {{1000, -5., 5.},
                         {800,  0.,  8.}});
        histos.add<TH2>("tracks/helium/h2TOFmass2HeliumVsPt",
                        "#Delta M^{2} (He) vs #it{p}_{T}; #Delta M^{2} (He); #it{p}_{T} (GeV/#it{c})", HistType::kTH2F,
                        {{1800, -9., 9.},
                         {800,  0.,  8.}});

        // MC histograms
        AxisSpec ptAxis = {2000, 0.f, 20.f, "#it{p}_{T} (GeV/#it{c})"};
        histos.add("spectraGen/histGenVetxZ", "PosZ generated events", HistType::kTH1F,
                   {{2000, -20.f, 20.f, "Vertex Z (cm)"}});
    ...
    void fillHistograms(const CollisionType &event, const TracksType &tracks) {
        ...
        for (auto &track : tracks) {
            ...
            if (track.hasTOF()) {
                ...
                if (std::abs(track.nsigTPCPr()) < nsigmaTPCcut)
                    histos.fill(HIST("tracks/proton/h2TOFmass2ProtonVsPt"),
                                massTOF * massTOF - fMassProton * fMassProton, track.pt());

                if (std::abs(track.nsigTPCD()) < nsigmaTPCcut)
                    histos.fill(HIST("tracks/deuteron/h2TOFmass2DeuteronVsPt"),
                                massTOF * massTOF - fMassDeuteron * fMassDeuteron, track.pt());

                if (std::abs(track.nsigTPC3He()) < nsigmaTPCcut)
                    histos.fill(HIST("tracks/helium/h2TOFmass2HeliumVsPt"),
                                massTOF * massTOF - fMassHelium * fMassHelium, track.pt());
            }
            if constexpr (IsMC) {
                track.pdgCode();
    ...
    PROCESS_SWITCH(LFNucleiBATask, processData,
    "process data", true);
    ...
    PROCESS_SWITCH(LFNucleiBATask, processMCReco,
    "process mc reco", false);
    Int_t nCount = 0;
    ...
    void processMCGen(aod::McCollision const &mcCollision, aod::McParticles_001 &mcParticles) {
        ...
        for (auto &mcParticleGen : mcParticles) {
            ...
            if (std::abs(mcParticleGen.pdgCode()) == PDGPion) {
                ...
                if (isPhysPrim) histos.fill(HIST("spectraGen/histGenPtPionPrim"), mcParticleGen.pt());
                if (!isPhysPrim && isProdByGen) histos.fill(HIST("spectraGen/histGenPtPionSec"), mcParticleGen.pt());
            ...
            if (std::abs(mcParticleGen.pdgCode()) == PDGKaon) {
                ...
                if (isPhysPrim) histos.fill(HIST("spectraGen/histGenPtKaonPrim"), mcParticleGen.pt());
                if (!isPhysPrim && isProdByGen) histos.fill(HIST("spectraGen/histGenPtKaonSec"), mcParticleGen.pt());
                if (!isPhysPrim && !isProdByGen)
            ...
            if (std::abs(mcParticleGen.pdgCode()) == PDGProton) {
                ...
                if (isPhysPrim) histos.fill(HIST("spectraGen/histGenPtProtonPrim"), mcParticleGen.pt());
                if (!isPhysPrim && isProdByGen) histos.fill(HIST("spectraGen/histGenPtProtonSec"), mcParticleGen.pt());
                if (!isPhysPrim && !isProdByGen)
            ...
            if (mcParticleGen.pdgCode() == PDGDeuteron) {
                ...
                if (isPhysPrim) histos.fill(HIST("spectraGen/histGenPtDPrim"), mcParticleGen.pt());
                if (!isPhysPrim && isProdByGen) histos.fill(HIST("spectraGen/histGenPtDSec"), mcParticleGen.pt());
                if (!isPhysPrim && !isProdByGen)
            ...
            if (mcParticleGen.pdgCode() == -PDGDeuteron) {
                ...
                if (isPhysPrim) histos.fill(HIST("spectraGen/histGenPtantiDPrim"), mcParticleGen.pt());
                if (!isPhysPrim && isProdByGen) histos.fill(HIST("spectraGen/histGenPtantiDSec"), mcParticleGen.pt());
                if (!isPhysPrim && !isProdByGen)
            ...
            if (mcParticleGen.pdgCode() == PDGHelium) {
                ...
                if (isPhysPrim) histos.fill(HIST("spectraGen/histGenPtHePrim"), mcParticleGen.pt());
                if (!isPhysPrim && isProdByGen) histos.fill(HIST("spectraGen/histGenPtHeSec"), mcParticleGen.pt());
                if (!isPhysPrim && !isProdByGen)
            ...
            if (mcParticleGen.pdgCode() == -PDGHelium) {
                ...
                if (isPhysPrim) histos.fill(HIST("spectraGen/histGenPtantiHePrim"), mcParticleGen.pt());
                if (!isPhysPrim && isProdByGen) histos.fill(HIST("spectraGen/histGenPtantiHeSec"), mcParticleGen.pt());
                if (!isPhysPrim && !isProdByGen)
                    histos.fill(HIST("spectraGen/histSecTransportPtantiHe"), mcParticleGen.pt());
            }
        }
    } // Close processMCGen
    PROCESS_SWITCH(LFNucleiBATask, processMCGen,
