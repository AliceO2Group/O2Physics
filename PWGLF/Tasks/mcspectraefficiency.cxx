...
struct ReconstructedTask {
  ...
  Filter trackCuts = (((aod::track::trackCutFlag & aod::track::TrackSelectionFlags::kGlobalTrack) == aod::track::TrackSelectionFlags::kGlobalTrack) || (aod::track::isGlobalTrackSDD == (uint8_t) true));
