...
struct derivedCascadeAnalysis {
  ...
  void processCascadesMCrec(soa::Join<aod::StraCollisions, aod::StraCents>::iterator const& coll, soa::Join<aod::CascCores, aod::CascExtras, aod::CascBBs, aod::CascMCCores> const& Cascades, soa::Join<aod::DauTrackExtras, aod::DauTrackTPCPIDs> const&, aod::MotherMCParts const&)
  {
    if (!IsEventAccepted(coll))
      return;
