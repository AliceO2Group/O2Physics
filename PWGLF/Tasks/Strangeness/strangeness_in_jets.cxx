...
using FullTracks = soa::Join<aod::Tracks, aod::TracksExtra, aod::TrackSelection,
...
struct strangeness_in_jets {
  ...
  // Global Parameters
  Configurable<float> ptLeadingMin{"ptLeadingMin", 5.0f, "minimum pt of leading particle"};
