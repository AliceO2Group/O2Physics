            ...
            if (TMath::Abs(v0.posTrack_as<MyTracks>().tpcNSigmaHe()) < TpcPidNsigmaCut && TMath::Abs(v0.negTrack_as<MyTracks>().tpcNSigmaPi()) < TpcPidNsigmaCut && TMath::Abs(v0.dcanegtopv()) > dcapiontopv) { //previous 900Gev pp analysis had nSigma< 5 for pt<0.7Gev and tpcNSigmaStorePr<3 for pt>0.7GeV; and no cut on K0S
              ...
              for (auto& particleMotherOfNeg : mcnegtrack.mothers_as<aod::McParticles>()) {
                for (auto& particleMotherOfPos : mcpostrack.mothers_as<aod::McParticles>()) {
                  if (particleMotherOfNeg == particleMotherOfPos && particleMotherOfNeg.pdgCode() == 1000020030) {
                    ...
                    if (particleMotherOfNeg.has_mothers()) {
                      ...
                      if (particleGrandMotherOfNeg.pdgCode() == 1000020030) {
                        registry.fill(HIST("hHypertritonFeedDownMatrix"), particleMotherOfNeg.pt(), particleGrandMotherOfNeg.pt());
                      }
                    }
                  }
                  if (saveDcaHist == 1) {
                    ...
                    if (particleMotherOfNeg.isPhysicalPrimary() && particleMotherOfNeg == particleMotherOfPos && particleMotherOfNeg.pdgCode() == 1000020030) {
                ...
                for (auto& particleMotherOfPos : mcpostrack.mothers_as<aod::McParticles>()) {
                  if (particleMotherOfNeg == particleMotherOfPos && particleMotherOfNeg.pdgCode() == -1000020030) {
                    ...
                    if (particleMotherOfNeg.has_mothers()) {
                      ...
                      auto particleGrandMotherOfNeg = particleGrandMothersOfNegTable[0];
                      if (particleGrandMotherOfNeg.pdgCode() == -1000020030) {
                        registry.fill(HIST("hAntiHypertritonFeedDownMatrix"), particleMotherOfNeg.pt(), particleGrandMotherOfNeg.pt());
                      }
                    }
                  }
                  if (saveDcaHist == 1) {
