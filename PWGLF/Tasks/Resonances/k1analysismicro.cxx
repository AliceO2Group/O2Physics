  ...
  bool isTrueK1(const T& trk1, const T& trk2, const T2& bTrack)
  {
    if (abs(trk1.pdgCode()) != kPiPlus || abs(trk2.pdgCode()) != kPiPlus)
      ...
      return false;
		...
		if (mother1 != mother2)
			return false;
		if (((abs(trk1.motherPDG()) && abs(trk2.motherPDG()) != kPDGRho770) && (abs(bTrack.motherPDG()) != kK1Plus)) 
				 || (abs(trk1.motherPDG()) && abs(bTrack.motherPDG()) != kK0Star892 && (abs(trk2.motherPDG()) != kK1Plus))
				 || (abs(trk2.motherPDG()) && abs(bTrack.motherPDG()) != kK0Star892 && (abs(trk1.motherPDG()) != kK1Plus)))
		return false;
