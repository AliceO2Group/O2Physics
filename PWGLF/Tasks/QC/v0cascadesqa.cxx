...
struct v0cascadesQA {
  ...
  ConfigurableAxis binV0ACosPA{"binV0ACosPA", {1000, 0.f, 1.0f}, ""};
  ...
  HistogramRegistry histos_Casc{
    "histos-Casc",
    {
      ...
      {"CascCosPA", "CascCosPA", {HistType::kTH2F, {{200, 0.6f, 1.0f}, {2, -2, 2}}}},
      {"V0CosPA", "V0CosPA", {HistType::kTH2F, {{300, 0.7f, 1.0f}, {2, -2, 2}}}},
      ...
      {"DcaV0ToPV", "DcaV0ToPV", {HistType::kTH2F, {{200, 0.0f, 2.f}, {2, -2, 2}}}},
      ...
      {"InvMassXiPlusVsPtVsCosPA", "InvMassXiPlusVsPtVsCosPA", {HistType::kTH3F, {{100, 0.f, 10.f}, {1000, 0.f, 1.0f}, {80, 1.28f, 1.36f}}}},
      {"InvMassXiMinusVsPtVsCosPA", "InvMassXiMinusVsPtVsCosPA", {HistType::kTH3F, {{100, 0.f, 10.f}, {1000, 0.f, 1.0f}, {80, 1.28f, 1.36f}}}},
      {"InvMassOmegaPlusVsPtVsCosPA", "InvMassOmegaPlusVsPtVsCosPA", {HistType::kTH3F, {{100, 0.f, 10.f}, {1000, 0.f, 1.0f}, {80, 1.63f, 1.71f}}}},
      {"InvMassOmegaMinusVsPtVsCosPA", "InvMassOmegaMinusVsPtVsCosPA", {HistType::kTH3F, {{100, 0.f, 10.f}, {1000, 0.f, 1.0f}, {80, 1.63f, 1.71f}}}},
    },
    OutputObjHandlingPolicy::AnalysisObject,
    false,
    true};
  ...
  void init(InitContext const&)
  {
    ...
    histos_V0.add("V0Radius", "V0Radius", kTH1D, {axisV0Radius});
    histos_V0.add("DecayLength", "DecayLength", kTH1F, {axisV0DecayLength});
    histos_V0.add("V0DCANegToPV", "V0DCANegToPV", kTH1F, {axisV0DCANegToPV});
    histos_V0.add("V0DCAPosToPV", "V0DCAPosToPV", kTH1F, {axisV0DCAPosToPV});
    histos_V0.add("V0DCAV0Daughters", "V0DCAV0Daughters", kTH1F, {axisV0DCAV0Dau});
    histos_V0.add("CtauK0s", "CtauK0s", kTH1F, {axisCtauK0s});
    histos_V0.add("CtauLambda", "CtauLambda", kTH1F, {axisCtauLambda});
    histos_V0.add("CtauAntiLambda", "CtauAntiLambda", kTH1F, {axisCtauAntiLambda});
    histos_V0.add("DecayLengthK0s", "DecayLengthK0s", kTH1F, {axisDecayLengthK0s});
    histos_V0.add("DecayLengthLambda", "DecayLengthLambda", kTH1F, {axisDecayLengthLambda});
    histos_V0.add("DecayLengthAntiLambda", "DecayLengthAntiLambda", kTH1F, {axisDecayLengthAntiLambda});
    histos_V0.add("V0DCAV0ToPVK0S", "V0DCAV0ToPVK0S", kTH1F, {axisV0DCAV0ToPVK0S});
    histos_V0.add("V0DCAV0ToPVLambda", "V0DCAV0ToPVLambda", kTH1F, {axisV0DCAV0ToPVLambda});
    histos_V0.add("V0DCAV0ToPVAntiLambda", "V0DCAV0ToPVAntiLambda", kTH1F, {axisV0DCAV0ToPVAntiLambda});
    histos_V0.add("InvMassK0S", "InvMassK0S", kTH2F, {axisPt, axisInvMassK0S});
    histos_V0.add("InvMassLambda", "InvMassLambda", kTH2F, {axisPt, axisInvMassLambda});
    histos_V0.add("InvMassAntiLambda", "InvMassAntiLambda", kTH2F, {axisPt, axisInvMassAntiLambda});
    histos_V0.add("ResponsePionFromLambda", "ResponsePionFromLambda", kTH2F, {axisPt, axisResponsePionFromLambda});
    histos_V0.add("ResponseProtonFromLambda", "ResponseProtonFromLambda", kTH2F, {axisPt, axisResponseProtonFromLambda});
    histos_V0.add("InvMassK0S_Radius", "InvMassK0S_Radius", kTH2F, {axisRadius, axisInvMassK0S});
    histos_V0.add("InvMassLambda_Radius", "InvMassLambda_Radius", kTH2F, {axisRadius, axisInvMassLambda});
    histos_V0.add("InvMassAntiLambda_Radius", "InvMassAntiLambda_Radius", kTH2F, {axisRadius, axisInvMassAntiLambda});
    histos_V0.add("InvMassK0S_EtaDaughters", "InvMassK0S_EtaDaughters", kTH3F, {axisEta, axisEta, axisInvMassK0S});
    histos_V0.add("InvMassLambda_EtaDaughters", "InvMassLambda_EtaDaughters", kTH3F, {axisEta, axisEta, axisInvMassLambda});
    histos_V0.add("InvMassAntiLambda_EtaDaughters", "InvMassAntiLambda_EtaDaughters", kTH3F, {axisEta, axisEta, axisInvMassAntiLambda});
    histos_V0.add("InvMassK0S_Ctau", "InvMassK0S_Ctau", kTH2F, {axisCtauK0s, axisInvMassK0S});
    histos_V0.add("InvMassLambda_Ctau", "InvMassLambda_Ctau", kTH2F, {axisCtauLambda, axisInvMassLambda});
    histos_V0.add("InvMassAntiLambda_Ctau", "InvMassAntiLambda_Ctau", kTH2F, {axisCtauAntiLambda, axisInvMassAntiLambda});
    histos_V0.add("InvMassK0S_PhiDaughters", "InvMassK0S_PhiDaughters", kTH3F, {axisPhi, axisPhi, axisInvMassK0S});
    histos_V0.add("InvMassLambda_PhiDaughters", "InvMassLambda_PhiDaughters", kTH3F, {axisPhi, axisPhi, axisInvMassLambda});
    histos_V0.add("InvMassAntiLambda_PhiDaughters", "InvMassAntiLambda_PhiDaughters", kTH3F, {axisPhi, axisPhi, axisInvMassAntiLambda});
    ...
    histos_V0.add("InvMassK0SVsPtVsCosPA", "InvMassK0SVsPtVsCosPA", kTH3F, {axisPt, binV0ACosPA, axisInvMassK0S});
    histos_V0.add("InvMassLambdaVsPtVsCosPA", "InvMassLambdaVsPtVsCosPA", kTH3F, {axisPt, binV0ACosPA, axisInvMassLambda});
    histos_V0.add("InvMassAntiLambdaVsPtVsCosPA", "InvMassAntiLambdaVsPtVsCosPA", kTH3F, {axisPt, binV0ACosPA, axisInvMassAntiLambda});
    ...
    for (auto& v0 : fullV0s) {
      ...
      if (v0.v0cosPA(collision.posX(), collision.posY(), collision.posZ()) > V0_cosPA) {
        if (v0.v0radius() > V0_radius && v0.dcaV0daughters() < V0_dcav0dau && TMath::Abs(v0.dcapostopv()) > V0_dcapostopv && TMath::Abs(v0.dcanegtopv()) > V0_dcanegtopv) {
          if (TMath::Abs(v0.yK0Short()) < V0_rapidity && CtauK0s < lifetimecut->get("lifetimecutK0S") && TMath::Abs(posdau.tpcNSigmaPi()) < NSigmaV0Pion && TMath::Abs(negdau.tpcNSigmaPi()) < NSigmaV0Pion) { // that s what we have in lambdakzeroanalysis ; discuss with nicolo chiara if we want to have more like in th aliphysics macro or none like in David's O2 QA
            ...
            histos_V0.fill(HIST("InvMassK0SVsPtVsCosPA"), v0.pt(), TMath::ACos(v0.v0cosPA(collision.posX(), collision.posY(), collision.posZ())), v0.mK0Short());
          ...
          if (TMath::Abs(v0.yLambda()) < V0_rapidity && CtauLambda < lifetimecut->get("lifetimecutLambda") && TMath::Abs(posdau.tpcNSigmaPr()) < NSigmaV0Proton && TMath::Abs(negdau.tpcNSigmaPi()) < NSigmaV0Pion) {
            ...
            histos_V0.fill(HIST("InvMassLambdaVsPtVsCosPA"), v0.pt(), TMath::ACos(v0.v0cosPA(collision.posX(), collision.posY(), collision.posZ())), v0.mLambda());
          ...
          if (TMath::Abs(v0.yLambda()) < V0_rapidity && CtauLambda < lifetimecut->get("lifetimecutLambda") && TMath::Abs(posdau.tpcNSigmaPi()) < NSigmaV0Pion && TMath::Abs(negdau.tpcNSigmaPr()) < NSigmaV0Proton) {
            ...
            histos_V0.fill(HIST("InvMassAntiLambdaVsPtVsCosPA"), v0.pt(), TMath::ACos(v0.v0cosPA(collision.posX(), collision.posY(), collision.posZ())), v0.mAntiLambda());
        ...
        if (casc.sign() < 0) {
          if (TMath::Abs(posdau.tpcNSigmaPr()) < NSigmaCascProton && TMath::Abs(negdau.tpcNSigmaPi()) < NSigmaCascPion) {
            if (TMath::Abs(casc.yXi()) < Casc_rapidity && TMath::Abs(bachelor.tpcNSigmaPi()) < NSigmaCascPion) {
              ...
              histos_Casc.fill(HIST("InvMassXiMinusVsPtVsCosPA"), casc.pt(), TMath::ACos(casc.casccosPA(collision.posX(), collision.posY(), collision.posZ())), casc.mXi());
            }
            if (TMath::Abs(casc.yOmega()) < Casc_rapidity && TMath::Abs(bachelor.tpcNSigmaKa()) < NSigmaCascKaon) {
              ...
              histos_Casc.fill(HIST("InvMassOmegaMinusVsPtVsCosPA"), casc.pt(), TMath::ACos(casc.casccosPA(collision.posX(), collision.posY(), collision.posZ())), casc.mOmega());
            }
          }
        } else {
          if (TMath::Abs(posdau.tpcNSigmaPi()) < NSigmaCascPion && TMath::Abs(negdau.tpcNSigmaPr()) < NSigmaCascProton) {
            if (TMath::Abs(casc.yXi()) < Casc_rapidity && TMath::Abs(bachelor.tpcNSigmaPi()) < NSigmaCascPion) {
              ...
              histos_Casc.fill(HIST("InvMassXiPlusVsPtVsCosPA"), casc.pt(), TMath::ACos(casc.casccosPA(collision.posX(), collision.posY(), collision.posZ())), casc.mXi());
            }
            if (TMath::Abs(casc.yOmega()) < Casc_rapidity && TMath::Abs(bachelor.tpcNSigmaKa()) < NSigmaCascKaon) {
              histos_Casc.fill(HIST("InvMassOmegaPlus"), casc.pt(), casc.mOmega());
              histos_Casc.fill(HIST("InvMassOmegaPlusVsPtVsCosPA"), casc.pt(), TMath::ACos(casc.casccosPA(collision.posX(), collision.posY(), collision.posZ())), casc.mOmega());
            }
          }
        }
      }
