...
struct v0cascadesQA {
  ...
  void init(InitContext const&)
  {
    ...
    histos_V0.add("V0Radius", "V0Radius", {HistType::kTH1D}, {axisV0Radius});
    ...
    histos_V0.add("InvMassK0S", "InvMassK0S", {HistType::kTH2F}, {axisPt, axisInvMassK0S});
    histos_V0.add("InvMassLambda", "InvMassLambda", {HistType::kTH2F}, {axisPt, axisInvMassLambda});
    histos_V0.add("InvMassAntiLambda", "InvMassAntiLambda", {HistType::kTH2F}, {axisPt, axisInvMassAntiLambda});
