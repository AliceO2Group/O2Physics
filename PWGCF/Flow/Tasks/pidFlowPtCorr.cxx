...
namespace
{
// Keep the corrconfigs vector layout in one named index table. Namespace
// grouping avoids storing compile-time constants as analysis-task members.
namespace corrConfigIndex
{
namespace charged
{
enum : std::size_t {
