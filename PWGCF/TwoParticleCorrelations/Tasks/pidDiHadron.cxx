...
struct PidDiHadron {
  ...
  PROCESS_SWITCH(PidDiHadron, processMCEfficiency, "MC: Extract efficiencies", false);
  ...
  PROCESS_SWITCH(PidDiHadron, processMCSame, "Process MC same event", false);
  ...
  PROCESS_SWITCH(PidDiHadron, processMCMixed, "Process MC mixed events", false);
  ...
  PROCESS_SWITCH(PidDiHadron, processOntheflySame, "Process on-the-fly same event", false);
  ...
  PROCESS_SWITCH(PidDiHadron, processOntheflyMixed, "Process on-the-fly mixed events", false);
