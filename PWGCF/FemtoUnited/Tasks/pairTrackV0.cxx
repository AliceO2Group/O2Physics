...
#include "PWGCF/FemtoUnited/Core/pairProcessHelpers.h"
...
struct PairTrackV0 {
  ...
  using Tracks = o2::soa::Join<FUTracks, FUTrackMasks>;
  using Lambdas = o2::soa::Join<FULambdas, FULambdaMasks>;
  using K0shorts = o2::soa::Join<FUK0shorts, FUK0shortMasks>;
  ...
  // setup lambdas
  v0selection::ConfLambdaSelection1 lambdaSelection;
  ...
  // setup k0shorts
  v0selection::ConfK0shortSelection1 k0shortSelection;
  ...
  closepairrejection::ClosePairRejection<
    closepairrejection::PrefixTrackVzeroSe,
    modes::Mode::kANALYSIS,
    modes::Pairs::kTrackV0>
    cprSe;
  closepairrejection::ClosePairRejection<
    closepairrejection::PrefixTrackVzeroMe,
    modes::Mode::kANALYSIS,
    modes::Pairs::kTrackV0>
    cprMe;
  paircleaner::PairCleaner<modes::Pairs::kTrackV0> pc;
