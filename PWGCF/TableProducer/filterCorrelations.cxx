...
struct FilterCF {
  ...
  O2_DEFINE_CONFIGURABLE(cfgMinOccupancy, int, 0, "Minimum occupancy selection")
  O2_DEFINE_CONFIGURABLE(cfgMaxOccupancy, int, 3000, "Maximum occupancy selection")
  ...
  bool keepCollision(TCollision& collision)
  {
    if (cfgTrigger == 0) {
      ...
      if (occupancy >= cfgMinOccupancy && occupancy < cfgMaxOccupancy)
