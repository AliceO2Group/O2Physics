...
struct femtoDreamTripletTaskTrackTrackV0PbPb {
  ...
  Configurable<o2::aod::femtodreamparticle::cutContainerType> ConfCutV0{"ConfCutV0", 7484, "V0 - Selection bit from cutCulator"};
  Configurable<o2::aod::femtodreamparticle::cutContainerType> Conf_ChildPos_CutV0{"Conf_ChildPos_CutV0", 8234, "Selection bit for positive child of V0"};
  Configurable<o2::aod::femtodreamparticle::cutContainerType> Conf_ChildPos_TPCBitV0{"Conf_ChildPos_TPCBitV0", 1024, "PID TPC bit for positive child of V0"};
  Configurable<o2::aod::femtodreamparticle::cutContainerType> Conf_ChildNeg_CutV0{"Conf_ChildNeg_CutV0", 8233, "Selection bit for negative child of V0"};
  Configurable<o2::aod::femtodreamparticle::cutContainerType> Conf_ChildNeg_TPCBitV0{"Conf_ChildNeg_TPCBitV0", 4096, "PID TPC bit for negative child of V0"};
  ...
  Configurable<float> Conf_minPt_V0{"Conf_minPt_V0", 0.0, "Minimum pT of V0"};
  Configurable<float> Conf_maxPt_V0{"Conf_maxPt_V0", 999.0, "Maximum pT of V0"};
