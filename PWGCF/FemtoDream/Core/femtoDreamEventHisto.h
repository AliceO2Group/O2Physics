...
class FemtoDreamEventHisto
{
 public:
  ...
  void init(o2::framework::HistogramRegistry* registry, bool isMC = false)
  {
    ...
    mHistogramRegistry->add("Event/hZvtx", "; vtx_{z} (cm); Entries", o2::framework::kTH1F, {{300, -12.5, 12.5}});
    mHistogramRegistry->add("Event/hMultPercentile", "; Multiplicity Percentile (FT0M); Entries", o2::framework::kTH1F, {{110, 0, 110}});
    mHistogramRegistry->add("Event/hMultNTr", "; Multiplicity (MultNtr); Entries", o2::framework::kTH1F, {{200, 0, 200}});
    mHistogramRegistry->add("Event/hMultNTrVsZvtx", "; Multiplicity (MultNtr); vtx_{z} (cm)", o2::framework::kTH2F, {{200, 0, 200}, {300, -12.5, 12.5}});
    mHistogramRegistry->add("Event/hMultNTrVsMultPercentile", "; Multiplicity (MultNtr); Multiplicity Percentile (FT0M)", o2::framework::kTH2F, {{200, 0, 200}, {110, 0, 110}});
    mHistogramRegistry->add("Event/hMultPercentileVsZvtx", "; Multiplicity Percentile (FT0M); vtx_{z} (cm)", o2::framework::kTH2F, {{110, 0, 110}, {300, -12.5, 12.5}});

    if (isMC) {
      mHistogramRegistry->add("Event_MC/hGenMult08VsMultPercentile", "; generated MC multiplicity (#eta<0.8); Multiplicity Percentile (FT0M)", o2::framework::kTH2F, {{200, 0, 200}, {110, 0, 110}});
    }
  }
