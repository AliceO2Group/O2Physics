...
void FemtoDreamCascadeSelection::init(o2::framework::HistogramRegistry* QAregistry, o2::framework::HistogramRegistry* Registry, bool isSelectCascOmega)
{
  ...
  if (QAregistry && Registry) {
    ...
    for (int istage = 0; istage < femtoDreamSelection::kNcutStages; istage++) {
      mQAHistogramRegistry->add((folderName + "/" + static_cast<std::string>(femtoDreamSelection::mCutStage[istage]) + "/hSign").c_str(), "; Sign of the Cascade ; Entries", o2::framework::HistType::kTH1I, {{3, -1, 2}});
      mQAHistogramRegistry->add((folderName + "/" + static_cast<std::string>(femtoDreamSelection::mCutStage[istage]) + "/hPt").c_str(), "; #it{p}_{T} (GeV/#it{c}); Entries", o2::framework::HistType::kTH1F, {{1000, 0, 10}});
      mQAHistogramRegistry->add((folderName + "/" + static_cast<std::string>(femtoDreamSelection::mCutStage[istage]) + "/hEta").c_str(), "; #eta; Entries", o2::framework::HistType::kTH1F, {{1000, -1, 1}});
      mQAHistogramRegistry->add((folderName + "/" + static_cast<std::string>(femtoDreamSelection::mCutStage[istage]) + "/hPhi").c_str(), "; #phi; Entries", o2::framework::HistType::kTH1F, {{1000, 0, 2. * M_PI}});
      mQAHistogramRegistry->add((folderName + "/" + static_cast<std::string>(femtoDreamSelection::mCutStage[istage]) + "/hDCADaugh").c_str(), "; daughters DCA; Entries", o2::framework::HistType::kTH1F, {DCADaughAxis});
      mQAHistogramRegistry->add((folderName + "/" + static_cast<std::string>(femtoDreamSelection::mCutStage[istage]) + "/hCPA").c_str(), "; Cos PA; Entries", o2::framework::HistType::kTH1F, {CPAAxis});
      mQAHistogramRegistry->add((folderName + "/" + static_cast<std::string>(femtoDreamSelection::mCutStage[istage]) + "/hTranRad").c_str(), "; Transverse Radius; Entries", o2::framework::HistType::kTH1F, {tranRadAxis});
      mQAHistogramRegistry->add((folderName + "/" + static_cast<std::string>(femtoDreamSelection::mCutStage[istage]) + "/hDecVtxX").c_str(), "; Decay vertex x position; Entries", o2::framework::HistType::kTH1F, {tranRadAxis});
      mQAHistogramRegistry->add((folderName + "/" + static_cast<std::string>(femtoDreamSelection::mCutStage[istage]) + "/hDecVtxY").c_str(), "; Decay vertex y position; Entries", o2::framework::HistType::kTH1F, {tranRadAxis});
      mQAHistogramRegistry->add((folderName + "/" + static_cast<std::string>(femtoDreamSelection::mCutStage[istage]) + "/hDecVtxZ").c_str(), "; Decay vertex z position; Entries", o2::framework::HistType::kTH1F, {tranRadAxis});
      mQAHistogramRegistry->add((folderName + "/" + static_cast<std::string>(femtoDreamSelection::mCutStage[istage]) + "/hInvMass").c_str(), "; Invariant mass; Entries", o2::framework::HistType::kTH1F, {massAxisCascade});
      mQAHistogramRegistry->add((folderName + "/" + static_cast<std::string>(femtoDreamSelection::mCutStage[istage]) + "/hV0DCADaugh").c_str(), "; V0-daughters DCA; Entries", o2::framework::HistType::kTH1F, {DCADaughAxis});
      mQAHistogramRegistry->add((folderName + "/" + static_cast<std::string>(femtoDreamSelection::mCutStage[istage]) + "/hV0CPA").c_str(), "; V0 cos PA; Entries", o2::framework::HistType::kTH1F, {CPAAxis});
      mQAHistogramRegistry->add((folderName + "/" + static_cast<std::string>(femtoDreamSelection::mCutStage[istage]) + "/hV0TranRad").c_str(), "; V0 transverse radius; Entries", o2::framework::HistType::kTH1F, {tranRadAxis});
      mQAHistogramRegistry->add((folderName + "/" + static_cast<std::string>(femtoDreamSelection::mCutStage[istage]) + "/hV0DCAToPV").c_str(), "; DCA of the V0 to the PV; Entries", o2::framework::HistType::kTH1F, {DCAToPVAxis});
      mQAHistogramRegistry->add((folderName + "/" + static_cast<std::string>(femtoDreamSelection::mCutStage[istage]) + "/hV0InvMass").c_str(), "; Invariant mass Cascade V0; Entries", o2::framework::HistType::kTH1F, {massAxisV0});
    }
