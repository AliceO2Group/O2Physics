...
void FemtoDreamTrackSelection::init(o2::framework::HistogramRegistry* QAregistry, o2::framework::HistogramRegistry* Registry)
{
  if (QAregistry && Registry) {
    ...
    for (int istage = 0; istage < femtoDreamSelection::kNcutStages; istage++) {
      mQAHistogramRegistry->add((folderName + "/" + static_cast<std::string>(femtoDreamSelection::mCutStage[istage]) + "/hPt").c_str(), "; #it{p}_{T} (GeV/#it{c}); Entries", o2::framework::kTH1F, {{240, 0, 6}});
      mQAHistogramRegistry->add((folderName + "/" + static_cast<std::string>(femtoDreamSelection::mCutStage[istage]) + "/hEta").c_str(), "; #eta; Entries", o2::framework::kTH1F, {{200, -1.5, 1.5}});
      mQAHistogramRegistry->add((folderName + "/" + static_cast<std::string>(femtoDreamSelection::mCutStage[istage]) + "/hPhi").c_str(), "; #phi; Entries", o2::framework::kTH1F, {{200, 0, 2. * M_PI}});
      mQAHistogramRegistry->add((folderName + "/" + static_cast<std::string>(femtoDreamSelection::mCutStage[istage]) + "/hTPCfindable").c_str(), "; TPC findable clusters; Entries", o2::framework::kTH1F, {{163, -0.5, 162.5}});
      mQAHistogramRegistry->add((folderName + "/" + static_cast<std::string>(femtoDreamSelection::mCutStage[istage]) + "/hTPCfound").c_str(), "; TPC found clusters; Entries", o2::framework::kTH1F, {{163, -0.5, 162.5}});
      mQAHistogramRegistry->add((folderName + "/" + static_cast<std::string>(femtoDreamSelection::mCutStage[istage]) + "/hTPCcrossedOverFindalbe").c_str(), "; TPC ratio findable; Entries", o2::framework::kTH1F, {{100, 0.5, 1.5}});
      mQAHistogramRegistry->add((folderName + "/" + static_cast<std::string>(femtoDreamSelection::mCutStage[istage]) + "/hTPCcrossedRows").c_str(), "; TPC crossed rows; Entries", o2::framework::kTH1F, {{163, 0, 163}});
      mQAHistogramRegistry->add((folderName + "/" + static_cast<std::string>(femtoDreamSelection::mCutStage[istage]) + "/hTPCfindableVsCrossed").c_str(), ";TPC findable clusters ; TPC crossed rows;", o2::framework::kTH2F, {{163, 0, 163}, {163, 0, 163}});
      mQAHistogramRegistry->add((folderName + "/" + static_cast<std::string>(femtoDreamSelection::mCutStage[istage]) + "/hTPCshared").c_str(), "; TPC shared clusters; Entries", o2::framework::kTH1F, {{163, -0.5, 162.5}});
      mQAHistogramRegistry->add((folderName + "/" + static_cast<std::string>(femtoDreamSelection::mCutStage[istage]) + "/hITSclusters").c_str(), "; ITS clusters; Entries", o2::framework::kTH1F, {{10, -0.5, 9.5}});
      mQAHistogramRegistry->add((folderName + "/" + static_cast<std::string>(femtoDreamSelection::mCutStage[istage]) + "/hITSclustersIB").c_str(), "; ITS clusters in IB; Entries", o2::framework::kTH1F, {{10, -0.5, 9.5}});
      mQAHistogramRegistry->add((folderName + "/" + static_cast<std::string>(femtoDreamSelection::mCutStage[istage]) + "/hDCAxy").c_str(), "; #it{p}_{T} (GeV/#it{c}); DCA_{xy} (cm)", o2::framework::kTH2F, {{100, 0, 10}, {500, -5, 5}});
      mQAHistogramRegistry->add((folderName + "/" + static_cast<std::string>(femtoDreamSelection::mCutStage[istage]) + "/hDCAz").c_str(), "; #it{p}_{T} (GeV/#it{c}); DCA_{z} (cm)", o2::framework::kTH2F, {{100, 0, 10}, {500, -5, 5}});
      mQAHistogramRegistry->add((folderName + "/" + static_cast<std::string>(femtoDreamSelection::mCutStage[istage]) + "/hDCA").c_str(), "; #it{p}_{T} (GeV/#it{c}); DCA (cm)", o2::framework::kTH2F, {{100, 0, 10}, {301, 0., 1.5}});
      mQAHistogramRegistry->add((folderName + "/" + static_cast<std::string>(femtoDreamSelection::mCutStage[istage]) + "/hTPCdEdX").c_str(), "; #it{p} (GeV/#it{c}); TPC Signal", o2::framework::kTH2F, {{100, 0, 10}, {1000, 0, 1000}});
      mQAHistogramRegistry->add((folderName + "/" + static_cast<std::string>(femtoDreamSelection::mCutStage[istage]) + "/nSigmaTPC_el").c_str(), "; #it{p} (GeV/#it{c}); n#sigma_{TPC}^{e}", o2::framework::kTH2F, {{100, 0, 10}, {100, -5, 5}});
      mQAHistogramRegistry->add((folderName + "/" + static_cast<std::string>(femtoDreamSelection::mCutStage[istage]) + "/nSigmaTPC_pi").c_str(), "; #it{p} (GeV/#it{c}); n#sigma_{TPC}^{#pi}", o2::framework::kTH2F, {{100, 0, 10}, {100, -5, 5}});
      mQAHistogramRegistry->add((folderName + "/" + static_cast<std::string>(femtoDreamSelection::mCutStage[istage]) + "/nSigmaTPC_K").c_str(), "; #it{p} (GeV/#it{c}); n#sigma_{TPC}^{K}", o2::framework::kTH2F, {{100, 0, 10}, {100, -5, 5}});
      mQAHistogramRegistry->add((folderName + "/" + static_cast<std::string>(femtoDreamSelection::mCutStage[istage]) + "/nSigmaTPC_p").c_str(), "; #it{p} (GeV/#it{c}); n#sigma_{TPC}^{p}", o2::framework::kTH2F, {{100, 0, 10}, {100, -5, 5}});
      mQAHistogramRegistry->add((folderName + "/" + static_cast<std::string>(femtoDreamSelection::mCutStage[istage]) + "/nSigmaTPC_d").c_str(), "; #it{p} (GeV/#it{c}); n#sigma_{TPC}^{d}", o2::framework::kTH2F, {{100, 0, 10}, {100, -5, 5}});
      mQAHistogramRegistry->add((folderName + "/" + static_cast<std::string>(femtoDreamSelection::mCutStage[istage]) + "/nSigmaTOF_el").c_str(), "; #it{p} (GeV/#it{c}); n#sigma_{TOF}^{e}", o2::framework::kTH2F, {{100, 0, 10}, {100, -5, 5}});
      mQAHistogramRegistry->add((folderName + "/" + static_cast<std::string>(femtoDreamSelection::mCutStage[istage]) + "/nSigmaTOF_pi").c_str(), "; #it{p} (GeV/#it{c}); n#sigma_{TOF}^{#pi}", o2::framework::kTH2F, {{100, 0, 10}, {100, -5, 5}});
      mQAHistogramRegistry->add((folderName + "/" + static_cast<std::string>(femtoDreamSelection::mCutStage[istage]) + "/nSigmaTOF_K").c_str(), "; #it{p} (GeV/#it{c}); n#sigma_{TOF}^{K}", o2::framework::kTH2F, {{100, 0, 10}, {100, -5, 5}});
      mQAHistogramRegistry->add((folderName + "/" + static_cast<std::string>(femtoDreamSelection::mCutStage[istage]) + "/nSigmaTOF_p").c_str(), "; #it{p} (GeV/#it{c}); n#sigma_{TOF}^{p}", o2::framework::kTH2F, {{100, 0, 10}, {100, -5, 5}});
      mQAHistogramRegistry->add((folderName + "/" + static_cast<std::string>(femtoDreamSelection::mCutStage[istage]) + "/nSigmaTOF_d").c_str(), "; #it{p} (GeV/#it{c}); n#sigma_{TOF}^{d}", o2::framework::kTH2F, {{100, 0, 10}, {100, -5, 5}});
      mQAHistogramRegistry->add((folderName + "/" + static_cast<std::string>(femtoDreamSelection::mCutStage[istage]) + "/nSigmaComb_el").c_str(), "; #it{p} (GeV/#it{c}); n#sigma_{comb}^{e}", o2::framework::kTH2F, {{100, 0, 10}, {100, -5, 5}});
      mQAHistogramRegistry->add((folderName + "/" + static_cast<std::string>(femtoDreamSelection::mCutStage[istage]) + "/nSigmaComb_pi").c_str(), "; #it{p} (GeV/#it{c}); n#sigma_{comb}^{#pi}", o2::framework::kTH2F, {{100, 0, 10}, {100, -5, 5}});
      mQAHistogramRegistry->add((folderName + "/" + static_cast<std::string>(femtoDreamSelection::mCutStage[istage]) + "/nSigmaComb_K").c_str(), "; #it{p} (GeV/#it{c}); n#sigma_{comb}^{K}", o2::framework::kTH2F, {{100, 0, 10}, {100, -5, 5}});
      mQAHistogramRegistry->add((folderName + "/" + static_cast<std::string>(femtoDreamSelection::mCutStage[istage]) + "/nSigmaComb_p").c_str(), "; #it{p} (GeV/#it{c}); n#sigma_{comb}^{p}", o2::framework::kTH2F, {{100, 0, 10}, {100, -5, 5}});
      mQAHistogramRegistry->add((folderName + "/" + static_cast<std::string>(femtoDreamSelection::mCutStage[istage]) + "/nSigmaComb_d").c_str(), "; #it{p} (GeV/#it{c}); n#sigma_{comb}^{d}", o2::framework::kTH2F, {{100, 0, 10}, {100, -5, 5}});
    }
  }
