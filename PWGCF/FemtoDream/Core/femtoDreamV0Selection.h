  ...
  if (QAregistry && Registry) {
    ...
    for (int istage = 0; istage < femtoDreamSelection::kNcutStages; istage++) {
      ...
      mQAHistogramRegistry->add((folderName + "/hPhi").c_str(), "; #phi; Entries",
                                o2::framework::kTH1F, {{1000, 0, 2. * M_PI}});
    ...
    mQAHistogramRegistry->add("LambdaQA/hInvMassLambdaNoCuts", "No cuts", o2::framework::kTH1F,
                              {massAxisLambda});
    ...
    mQAHistogramRegistry->add("LambdaQA/hInvMassLambdaCPA", "CPA cut", o2::framework::kTH1F,
                              {massAxisLambda});
