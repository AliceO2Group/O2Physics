...
void FemtoDreamV0Selection::init(o2::framework::HistogramRegistry* QAregistry, o2::framework::HistogramRegistry* Registry)
{
  if (QAregistry && Registry) {
    ...
    mQAHistogramRegistry->add(folderName + "QA/hInvMassLambdaNoCuts", "No cuts", o2::framework::HistType::kTH1F,
                              {massAxisLambda});
    ...
    mQAHistogramRegistry->add(folderName + "QA/hInvMassLambdaCPA", "CPA cut", o2::framework::HistType::kTH1F,
                              {massAxisLambda});
