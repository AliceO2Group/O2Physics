...
class FemtoDreamContainerThreeBody
{
 public:
  ...
  void init_base(std::string folderName, std::string femtoObs, T femtoObsAxis, T multAxis)
  {
    ...
    mHistogramRegistry->add((folderName + "/relTripletQ3Mult").c_str(), ("; " + femtoObs + "; Multiplicity").c_str(), o2::framework::HistType::kTH2F, {femtoObsAxis, multAxis});
    mHistogramRegistry->add((folderName + "/mT1").c_str(), ";mT; Q3", o2::framework::HistType::kTH2F, {{1000, 0, 25}, femtoObsAxis});
    mHistogramRegistry->add((folderName + "/mT2").c_str(), ";mT; Q3", o2::framework::HistType::kTH2F, {{1000, 0, 25}, femtoObsAxis});
    mHistogramRegistry->add((folderName + "/mT3").c_str(), ";mT; Q3", o2::framework::HistType::kTH2F, {{1000, 0, 25}, femtoObsAxis});
    mHistogramRegistry->add((folderName + "/mTAverage").c_str(), ";mT; Q3", o2::framework::HistType::kTH2F, {{1000, 0, 25}, femtoObsAxis});
  }
  ...
  void init_MC(std::string folderName, std::string femtoObs, T femtoObsAxis, T multAxis)
  {
    ...
    mHistogramRegistry->add((folderName + "/hNoMCtruthTripletCounter").c_str(), "; Counter; Entries", o2::framework::HistType::kTH1I, {{1, 0, 1}});
    mHistogramRegistry->add((folderName + "/hFakeTripletCounter").c_str(), "; Counter; Entries", o2::framework::HistType::kTH1I, {{1, 0, 1}});
    mHistogramRegistry->add((folderName + "/Q3_resolution").c_str(), "; #it{Q}_{3} reconstructed (GeV/#it{c}); #it{Q}_{3} truth (GeV/#it{c})", o2::framework::HistType::kTH2F, {femtoObsAxis, femtoObsAxis});
  }
