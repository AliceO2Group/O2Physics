...
namespace o2::analysis::femtoDream
{
 namespace femtoDreamResoSelection
    ...
    public:
      ...
      float getMass(o2::track::PID::ID pid)
      {
        switch(pid){
          ...
          default:  LOG(warn) << "PID not implemented in femtoDreamResoSelection.getMass";
                    return 0.;
        }
      }
  ...
  std::pair<o2::track::PID::ID, o2::track::PID::ID> FemtoDreamResoSelection::getPIDPairFromMother(femtoDreamResoSelection::ResoMothers mother)
  {
    ...
    switch(mother){
      case (femtoDreamResoSelection::kPhi): return {o2::track::PID::Kaon, o2::track::PID::Kaon};
      case (femtoDreamResoSelection::kKStar): return {o2::track::PID::Kaon, o2::track::PID::Pion};
      default: LOG(warn) << "MotherPID not implemented in femtoDreamResoSelection.getPIDPairFromMother";
  ...
  {
    switch(mother){
      case (femtoDreamResoSelection::kPhi): return {o2::constants::physics::MassKPlus, o2::constants::physics::MassKPlus};
      case (femtoDreamResoSelection::kKStar): return {o2::constants::physics::MassKPlus, o2::constants::physics::MassPiPlus};
      default: LOG(warn) << "MotherPID not implemented in femtoDreamResoSelection.getMassDauhters";
  ...
  std::array<cutContainerType, 5> FemtoDreamResoSelection::getCutContainer(V const& track1, V const& track2, float sign)
  {
    ...
    const auto shiftvalue = numBitsUsed(outputPosTrack.at(femtoDreamTrackSelection::TrackContainerPosition::kPID));
    outputPID = (outputNegTrack.at(femtoDreamTrackSelection::TrackContainerPosition::kPID)<< shiftvalue )| outputNegTrack.at(femtoDreamTrackSelection::TrackContainerPosition::kPID);
