...
/// \file O2FemtoParticleHisto.h
/// \brief O2FemtoParticleHisto - Histogram class for tracks, V0s and cascades
/// \author Andi Mathis, TU München, andreas.mathis@ph.tum.de

#ifndef ANALYSIS_TASKS_PWGCF_O2FEMTO_INCLUDE_O2FEMTO_FEMTOPARTICLEHISTO_H_
#define ANALYSIS_TASKS_PWGCF_O2FEMTO_INCLUDE_O2FEMTO_FEMTOPARTICLEHISTO_H_
...
class O2FemtoParticleHisto
{
 public:
  /// Destructor
  virtual ~O2FemtoParticleHisto() = default;
  ...
  void init(HistogramRegistry* registry)
  {
    if (registry) {
      ...
      if constexpr (mParticleType == o2::aod::femtodreamparticle::ParticleType::kTrack) {
        ...
        LOG(fatal) << "O2FemtoParticleHisto: Histogramming for requested object not defined - quitting!";
      }
    }
  }
...
#endif /* ANALYSIS_TASKS_PWGCF_O2FEMTO_INCLUDE_O2FEMTO_FEMTOPARTICLEHISTO_H_ */
