...
/// \file O2FemtoPairCleaner.h
/// \brief O2FemtoPairCleaner - Makes sure only proper candidates are paired
/// \author Andi Mathis, TU München, andreas.mathis@ph.tum.de, Laura Serksnyte <laura.serksnyte@cern.ch>, TU München

#ifndef ANALYSIS_TASKS_PWGCF_O2FEMTO_INCLUDE_O2FEMTO_O2FEMTOPAIRCLEANER_H_
#define ANALYSIS_TASKS_PWGCF_O2FEMTO_INCLUDE_O2FEMTO_O2FEMTOPAIRCLEANER_H_
...
class O2FemtoPairCleaner
{
 public:
  /// Destructor
  virtual ~O2FemtoPairCleaner() = default;
  ...
  void init(HistogramRegistry* registry)
  {
    if (registry) {
      ...
      // \todo some QA histograms like in O2Femto
    }
  }
  ...
  bool isCleanPair(Part const& part1, Part const& part2, Parts const& particles)
  {
    if constexpr (mPartOneType == o2::aod::femtodreamparticle::ParticleType::kTrack && mPartTwoType == o2::aod::femtodreamparticle::ParticleType::kTrack) {
      ...
      if (part1.partType() != o2::aod::femtodreamparticle::ParticleType::kTrack || part2.partType() != o2::aod::femtodreamparticle::ParticleType::kTrack) {
        LOG(fatal) << "O2FemtoPairCleaner: passed arguments don't agree with O2FemtoPairCleaner instantiation! Please provide kTrack,kTrack candidates.";
        return false;
      }
      ...
      if (part2.partType() != o2::aod::femtodreamparticle::ParticleType::kV0) {
        LOG(fatal) << "O2FemtoPairCleaner: passed arguments don't agree with O2FemtoPairCleaner instantiation! Please provide second argument kV0 candidate.";
        return false;
      }
      ...
      LOG(fatal) << "O2FemtoPairCleaner: Combination of objects not defined - quitting!";
      return false;
    }
  }
...
#endif /* ANALYSIS_TASKS_PWGCF_O2FEMTO_INCLUDE_O2FEMTO_O2FEMTOPAIRCLEANER_H_ */
