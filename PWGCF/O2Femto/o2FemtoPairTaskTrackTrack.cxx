...
/// \file o2FemtoPairTaskTrackTrack.cxx
...
#include "O2FemtoParticleHisto.h"
#include "O2FemtoEventHisto.h"
#include "O2FemtoPairCleaner.h"
#include "O2FemtoContainer.h"
#include "O2FemtoDetaDphiStar.h"
#include "O2FemtoUtils.h"

using namespace o2;
using namespace o2::analysis::o2Femto;
...
struct o2FemtoPairTaskTrackTrack {
  ...
  O2FemtoParticleHisto<aod::femtodreamparticle::ParticleType::kTrack, 1> trackHistoPartOne;
  ...
  O2FemtoParticleHisto<aod::femtodreamparticle::ParticleType::kTrack, 2> trackHistoPartTwo;

  /// Histogramming for Event
  O2FemtoEventHisto eventHisto;
  ...
  O2FemtoContainer<o2FemtoContainer::EventType::same, o2FemtoContainer::Observable::kstar> sameEventCont;

  O2FemtoContainer<o2FemtoContainer::EventType::mixed, o2FemtoContainer::Observable::kstar> mixedEventCont;
  O2FemtoPairCleaner<aod::femtodreamparticle::ParticleType::kTrack, aod::femtodreamparticle::ParticleType::kTrack> pairCleaner;
  O2FemtoDetaDphiStar<aod::femtodreamparticle::ParticleType::kTrack, aod::femtodreamparticle::ParticleType::kTrack> pairCloseRejection;
  /// Histogram output
  ...
  PROCESS_SWITCH(o2FemtoPairTaskTrackTrack, processSameEvent, "Enable processing same event", true);
  ...
  PROCESS_SWITCH(o2FemtoPairTaskTrackTrack, processMixedEvent, "Enable processing mixed events", true);
};

WorkflowSpec defineDataProcessing(ConfigContext const& cfgc)
{
  WorkflowSpec workflow{
    adaptAnalysisTask<o2FemtoPairTaskTrackTrack>(cfgc),
  };
  return workflow;
}
