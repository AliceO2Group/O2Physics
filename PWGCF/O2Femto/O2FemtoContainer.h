...
/// \file O2FemtoContainer.h
/// \brief Definition of the O2FemtoContainer
/// \author Andi Mathis, TU München, andreas.mathis@ph.tum.de
/// \author Valentina Mantovani Sarti, valentina.mantovani-sarti@tum.de

#ifndef ANALYSIS_TASKS_PWGCF_O2FEMTO_O2FEMTOCONTAINER_H_
#define ANALYSIS_TASKS_PWGCF_O2FEMTO_O2FEMTOCONTAINER_H_

#include "Framework/HistogramRegistry.h"
#include "O2FemtoMath.h"
...
namespace o2::analysis::o2Femto
{

namespace o2FemtoContainer
{
...
template <o2FemtoContainer::EventType eventType, o2FemtoContainer::Observable obs>
class O2FemtoContainer
{
 public:
  /// Destructor
  virtual ~O2FemtoContainer() = default;
  ...
  void init(HistogramRegistry* registry, T& kstarBins, T& multBins, T& kTBins, T& mTBins)
  {
    ...
    std::string femtoObs;
    if constexpr (mFemtoObs == o2FemtoContainer::Observable::kstar) {
  ...
  /// \tparam T type of the o2femtoparticle
  ...
  void setPair(T const& part1, T const& part2, const int mult)
  {
    float femtoObs;
    if constexpr (mFemtoObs == o2FemtoContainer::Observable::kstar) {
      femtoObs = O2FemtoMath::getkstar(part1, mMassOne, part2, mMassTwo);
    }
    const float kT = O2FemtoMath::getkT(part1, mMassOne, part2, mMassTwo);
    const float mT = O2FemtoMath::getmT(part1, mMassOne, part2, mMassTwo);
 ...
 protected:
  ...
  static constexpr o2FemtoContainer::Observable mFemtoObs = obs;                      ///< Femtoscopic observable to be computed (according to o2FemtoContainer::Observable)
  static constexpr int mEventType = eventType;                                        ///< Type of the event (same/mixed, according to o2FemtoContainer::EventType)
...
#endif /* ANALYSIS_TASKS_PWGCF_O2FEMTO_O2FEMTOCONTAINER_H_ */
