...
struct femtoUniversePairTaskTrackPhi {
  ...
  struct : o2::framework::ConfigurableGroup {
    ...
    Configurable<int> ConfTrackChoiceTrack{"ConfTrackChoiceTrack", 0, "Type of particle (track): {0:Proton, 1:Pion, 2:Kaon}"};
  ...
  Partition<FemtoFullParticles> partsTrack = (aod::femtouniverseparticle::partType == uint8_t(aod::femtouniverseparticle::ParticleType::kTrack));
  ...
  {
    switch (ConfTrack.ConfTrackChoiceTrack) {
      case 0: // Proton
