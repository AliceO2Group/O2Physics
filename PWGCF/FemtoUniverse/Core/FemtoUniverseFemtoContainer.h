...
class FemtoUniverseFemtoContainer
{
 public:
  ...
  template <typename T>
  void initBase(const std::string& folderName, const std::string& femtoObs, T femtoObsAxis, T multAxis, T kTAxis, T mTAxis, T multAxis3D, T mTAxis3D, bool use3dplots)
  {
