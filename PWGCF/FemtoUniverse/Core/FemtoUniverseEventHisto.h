...
class FemtoUniverseEventHisto
{
 public:
  ...
  void init(o2::framework::HistogramRegistry* registry)
  {
    ...
    mHistogramRegistry->add("Event/zvtxhist", "; vtx_{z} (cm); Entries", o2::framework::HistType::kTH1F, {{250, -12.5, 12.5}});
    mHistogramRegistry->add("Event/MultV0M", "; vMultV0M; Entries", o2::framework::HistType::kTH1F, {{2000, 0, 20000}});
    mHistogramRegistry->add("Event/MultNTr", "; vMultNTr; Entries", o2::framework::HistType::kTH1F, {{20, 0, 200}});
    mHistogramRegistry->add("Event/MultNTrVSMultV0M", "; vMultNTr; MultV0M", o2::framework::HistType::kTH2F, {{200, 0, 4000}, {2000, 0, 20000}});
    mHistogramRegistry->add("Event/zvtxhist_MultNTr", "; zvtxhist; MultNTr", o2::framework::HistType::kTH2F, {{250, -12.5, 12.5}, {20, 0, 200}});
  }
