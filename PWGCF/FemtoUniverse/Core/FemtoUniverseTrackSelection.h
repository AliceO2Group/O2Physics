...
template <o2::aod::femtouniverseparticle::ParticleType part, o2::aod::femtouniverseparticle::TrackType tracktype, typename CutContainerType>
void FemtoUniverseTrackSelection::init(o2::framework::HistogramRegistry* registry)
{
  if (registry) {
    ...
    mHistogramRegistry->add((folderName + "/hPhi").c_str(), "; #phi; Entries", o2::framework::HistType::kTH1F, {{200, 0, o2::constants::math::TwoPI}});
    ...
    mHistogramRegistry->add((folderName + "/hTPCfractionSharedCls").c_str(), "; TPC fraction of shared clusters; Entries", o2::framework::HistType::kTH1F, {{100, 0.0, 100.0}});
    ...
    mHistogramRegistry->add((folderName + "/nSigmaITS_el").c_str(), "; #it{p} (GeV/#it{c}); n#sigma_{ITS}^{e}", o2::framework::HistType::kTH2F, {{100, 0, 10}, {200, -4.975, 5.025}});
    mHistogramRegistry->add((folderName + "/nSigmaITS_pi").c_str(), "; #it{p} (GeV/#it{c}); n#sigma_{ITS}^{#pi}", o2::framework::HistType::kTH2F, {{100, 0, 10}, {200, -4.975, 5.025}});
    mHistogramRegistry->add((folderName + "/nSigmaITS_K").c_str(), "; #it{p} (GeV/#it{c}); n#sigma_{ITS}^{K}", o2::framework::HistType::kTH2F, {{100, 0, 10}, {200, -4.975, 5.025}});
    mHistogramRegistry->add((folderName + "/nSigmaITS_p").c_str(), "; #it{p} (GeV/#it{c}); n#sigma_{ITS}^{p}", o2::framework::HistType::kTH2F, {{100, 0, 10}, {200, -4.975, 5.025}});
    mHistogramRegistry->add((folderName + "/nSigmaITS_d").c_str(), "; #it{p} (GeV/#it{c}); n#sigma_{ITS}^{d}", o2::framework::HistType::kTH2F, {{100, 0, 10}, {200, -4.975, 5.025}});
    mHistogramRegistry->add((folderName + "/nSigmaTPC_el").c_str(), "; #it{p} (GeV/#it{c}); n#sigma_{TPC}^{e}", o2::framework::HistType::kTH2F, {{100, 0, 10}, {200, -4.975, 5.025}});
    mHistogramRegistry->add((folderName + "/nSigmaTPC_pi").c_str(), "; #it{p} (GeV/#it{c}); n#sigma_{TPC}^{#pi}", o2::framework::HistType::kTH2F, {{100, 0, 10}, {200, -4.975, 5.025}});
    mHistogramRegistry->add((folderName + "/nSigmaTPC_K").c_str(), "; #it{p} (GeV/#it{c}); n#sigma_{TPC}^{K}", o2::framework::HistType::kTH2F, {{100, 0, 10}, {200, -4.975, 5.025}});
    mHistogramRegistry->add((folderName + "/nSigmaTPC_p").c_str(), "; #it{p} (GeV/#it{c}); n#sigma_{TPC}^{p}", o2::framework::HistType::kTH2F, {{100, 0, 10}, {200, -4.975, 5.025}});
    mHistogramRegistry->add((folderName + "/nSigmaTPC_d").c_str(), "; #it{p} (GeV/#it{c}); n#sigma_{TPC}^{d}", o2::framework::HistType::kTH2F, {{100, 0, 10}, {200, -4.975, 5.025}});
    mHistogramRegistry->add((folderName + "/nSigmaTOF_el").c_str(), "; #it{p} (GeV/#it{c}); n#sigma_{TOF}^{e}", o2::framework::HistType::kTH2F, {{100, 0, 10}, {200, -4.975, 5.025}});
    mHistogramRegistry->add((folderName + "/nSigmaTOF_pi").c_str(), "; #it{p} (GeV/#it{c}); n#sigma_{TOF}^{#pi}", o2::framework::HistType::kTH2F, {{100, 0, 10}, {200, -4.975, 5.025}});
    mHistogramRegistry->add((folderName + "/nSigmaTOF_K").c_str(), "; #it{p} (GeV/#it{c}); n#sigma_{TOF}^{K}", o2::framework::HistType::kTH2F, {{100, 0, 10}, {200, -4.975, 5.025}});
    mHistogramRegistry->add((folderName + "/nSigmaTOF_p").c_str(), "; #it{p} (GeV/#it{c}); n#sigma_{TOF}^{p}", o2::framework::HistType::kTH2F, {{100, 0, 10}, {200, -4.975, 5.025}});
    mHistogramRegistry->add((folderName + "/nSigmaTOF_d").c_str(), "; #it{p} (GeV/#it{c}); n#sigma_{TOF}^{d}", o2::framework::HistType::kTH2F, {{100, 0, 10}, {200, -4.975, 5.025}});
    mHistogramRegistry->add((folderName + "/nSigmaComb_el").c_str(), "; #it{p} (GeV/#it{c}); n#sigma_{comb}^{e}", o2::framework::HistType::kTH2F, {{100, 0, 10}, {200, -4.975, 5.025}});
    mHistogramRegistry->add((folderName + "/nSigmaComb_pi").c_str(), "; #it{p} (GeV/#it{c}); n#sigma_{comb}^{#pi}", o2::framework::HistType::kTH2F, {{100, 0, 10}, {200, -4.975, 5.025}});
    mHistogramRegistry->add((folderName + "/nSigmaComb_K").c_str(), "; #it{p} (GeV/#it{c}); n#sigma_{comb}^{K}", o2::framework::HistType::kTH2F, {{100, 0, 10}, {200, -4.975, 5.0255}});
    mHistogramRegistry->add((folderName + "/nSigmaComb_p").c_str(), "; #it{p} (GeV/#it{c}); n#sigma_{comb}^{p}", o2::framework::HistType::kTH2F, {{100, 0, 10}, {200, -4.975, 5.025}});
    mHistogramRegistry->add((folderName + "/nSigmaComb_d").c_str(), "; #it{p} (GeV/#it{c}); n#sigma_{comb}^{d}", o2::framework::HistType::kTH2F, {{100, 0, 10}, {200, -4.975, 5.025}});
  }
  /// set cuts
