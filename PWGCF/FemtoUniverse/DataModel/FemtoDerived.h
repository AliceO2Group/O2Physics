...
DECLARE_SOA_TABLE(FdCollisions, "AOD", "FDCOLLISION", o2::soa::Index<>,
                  o2::aod::collision::PosZ, femtouniversecollision::MultV0M,
...
DECLARE_SOA_COLUMN(TpcNClsFound, tpcNClsFound,
                   uint8_t); //! Number of TPC clusters
DECLARE_SOA_COLUMN(TpcNClsCrossedRows, tpcNClsCrossedRows,
                   uint8_t); //! Number of TPC crossed rows
DECLARE_SOA_COLUMN(TpcFractionSharedCls, tpcFractionSharedCls,
...
DECLARE_SOA_COLUMN(DecayVtxX, decayVtxX,
                   float); //! X position of the decay vertex
DECLARE_SOA_COLUMN(DecayVtxY, decayVtxY,
                   float); //! Y position of the decay vertex
DECLARE_SOA_COLUMN(DecayVtxZ, decayVtxZ,
                   float); //! Z position of the decay vertex
DECLARE_SOA_COLUMN(MKaon, mKaon,
                   float); //! The invariant mass of V0 candidate, assuming kaon

} // namespace femtouniverseparticle

DECLARE_SOA_TABLE(FDParticles, "AOD", "FDPARTICLE", o2::soa::Index<>,
                  femtouniverseparticle::FdCollisionId,
                  femtouniverseparticle::Pt, femtouniverseparticle::Eta,
                  femtouniverseparticle::Phi, femtouniverseparticle::PartType,
                  femtouniverseparticle::Cut, femtouniverseparticle::PidCut,
                  ...
                  femtouniverseparticle::Px<femtouniverseparticle::Pt,
                                            femtouniverseparticle::Phi>,
                  femtouniverseparticle::Py<femtouniverseparticle::Pt,
                                            femtouniverseparticle::Phi>,
                  femtouniverseparticle::Pz<femtouniverseparticle::Pt,
                                            femtouniverseparticle::Eta>,
                  femtouniverseparticle::P<femtouniverseparticle::Pt,
                                           femtouniverseparticle::Eta>);
...
DECLARE_SOA_COLUMN(Dcanegtopv, dcanegtopv,
                   float); //! DCA of negative daughter to PV
DECLARE_SOA_COLUMN(Dcabachtopv, dcabachtopv,
                   float);                       //! DCA of bachelor track to PV
...
DECLARE_SOA_TABLE(FDCascParticles, "AOD", "FDCASCPARTICLE", o2::soa::Index<>,
                  femtouniverseparticle::FdCollisionId,
...
// debug variables
DECLARE_SOA_COLUMN(MotherPDG, motherPDG,
                   int); //! Checks mother PDG, where mother is the primary
                         //! particle for that decay chain
} // namespace femtouniverse_mc_particle

DECLARE_SOA_TABLE(FdMCParticles, "AOD", "FDMCPARTICLE", o2::soa::Index<>,
