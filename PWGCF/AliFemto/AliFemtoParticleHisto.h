...
/// \file AliFemtoParticleHisto.h
/// \brief AliFemtoParticleHisto - Histogram class for tracks, V0s and cascades
/// \author Andi Mathis, TU München, andreas.mathis@ph.tum.de

#ifndef ANALYSIS_TASKS_PWGCF_O2ALIFEMTO_INCLUDE_O2ALIFEMTO_ALIFEMTOPARTICLEHISTO_H_
...
class AliFemtoParticleHisto
{
 public:
  /// Destructor
  virtual ~AliFemtoParticleHisto() = default;
  ...
  void init(HistogramRegistry* registry)
  {
    if (registry) {
      ...
      if constexpr (mParticleType == o2::aod::femtodreamparticle::ParticleType::kTrack) {
        ...
        LOG(fatal) << "AliFemtoParticleHisto: Histogramming for requested object not defined - quitting!";
      }
    }
  }
...
#endif /* ANALYSIS_TASKS_PWGCF_O2ALIFEMTO_INCLUDE_O2ALIFEMTO_ALIFEMTOPARTICLEHISTO_H_ */
