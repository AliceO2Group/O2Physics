...
/// \file AliFemtoPairCleaner.h
/// \brief AliFemtoPairCleaner - Makes sure only proper candidates are paired
/// \author Andi Mathis, TU München, andreas.mathis@ph.tum.de, Laura Serksnyte <laura.serksnyte@cern.ch>, TU München

#ifndef ANALYSIS_TASKS_PWGCF_O2ALIFEMTO_INCLUDE_O2ALIFEMTO_ALIFEMTOPAIRCLEANER_H_
#define ANALYSIS_TASKS_PWGCF_O2ALIFEMTO_INCLUDE_O2ALIFEMTO_ALIFEMTOPAIRCLEANER_H_
...
class AliFemtoPairCleaner
{
 public:
  /// Destructor
  virtual ~AliFemtoPairCleaner() = default;
  ...
  void init(HistogramRegistry* registry)
  {
    if (registry) {
      ...
      // \todo some QA histograms like in AliFemto
    }
  }
  ...
  bool isCleanPair(Part const& part1, Part const& part2, Parts const& particles)
  {
    if constexpr (mPartOneType == o2::aod::femtodreamparticle::ParticleType::kTrack && mPartTwoType == o2::aod::femtodreamparticle::ParticleType::kTrack) {
      ...
      if (part1.partType() != o2::aod::femtodreamparticle::ParticleType::kTrack || part2.partType() != o2::aod::femtodreamparticle::ParticleType::kTrack) {
        LOG(fatal) << "AliFemtoPairCleaner: passed arguments don't agree with AliFemtoPairCleaner instantiation! Please provide kTrack,kTrack candidates.";
        return false;
      }
      ...
      if (part2.partType() != o2::aod::femtodreamparticle::ParticleType::kV0) {
        LOG(fatal) << "AliFemtoPairCleaner: passed arguments don't agree with AliFemtoPairCleaner instantiation! Please provide second argument kV0 candidate.";
        return false;
      }
      ...
      LOG(fatal) << "AliFemtoPairCleaner: Combination of objects not defined - quitting!";
      return false;
    }
  }
...
#endif /* ANALYSIS_TASKS_PWGCF_O2ALIFEMTO_INCLUDE_O2ALIFEMTO_ALIFEMTOPAIRCLEANER_H_ */
