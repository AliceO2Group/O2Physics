 ...
 public:
  ...
  void init(o2::framework::HistogramRegistry* registry)
  {
    if (registry) {
      ...
      mHistogramRegistry->add((folderName + "/dEdxTPCVsMomentum").c_str(), "; #it{p} (GeV/#it{c}); dE/dx (keV/cm)", o2::framework::HistType::kTH2F, {{200, 0., 5.}, {250, 0., 500.}});
      mHistogramRegistry->add((folderName + "/TOFBetaVsMomentum").c_str(), "; #it{p} (GeV/#it{c}); TOF #beta", o2::framework::HistType::kTH2F, {{200, 0., 5.}, {250, 0.4, 1.1}});

      /// Particle-type specific histograms
      if constexpr (mParticleType == o2::aod::femtoworldparticle::ParticleType::kTrack) {
        /// Track histograms
        mHistogramRegistry->add((folderName + "/hDCAxy").c_str(), "; #it{p}_{T} (GeV/#it{c}); DCA_{xy} (cm)", o2::framework::HistType::kTH2F, {{20, 0.5, 4.05}, {500, -5, 5}});
        mHistogramRegistry->add((folderName + "/hDCAz").c_str(), "; #it{p}_{T} (GeV/#it{c}); DCA_{z} (cm)", o2::framework::HistType::kTH2F, {{20, 0.5, 4.05}, {500, -5, 5}});
      } else if constexpr (mParticleType == o2::aod::femtoworldparticle::ParticleType::kV0) {
        /// V0 histograms
        mHistogramRegistry->add((folderName + "/hCPA").c_str(), "; #it{p}_{T} (GeV/#it{c}); cos#alpha", o2::framework::HistType::kTH2F, {{8, 0.3, 4.3}, {1000, 0.9, 1}});
        ...
        mHistogramRegistry->add((folderName + "/InvariantMass").c_str(), ";M_{K^{+}K^{-}} (GeV/#it{c}^{2});", o2::framework::HistType::kTH1D, {mInvAxis});
        mHistogramRegistry->add((folderName + "/EtaVsMultiplicity").c_str(), "; multiplicity; #eta", o2::framework::HistType::kTH2F, {{12, 0., 200.}, {29, -2., 2.}});
      } else if constexpr (mParticleType == o2::aod::femtoworldparticle::ParticleType::kPhiChild) {
        /// Phi daughters histograms
        mHistogramRegistry->add((folderName + "/TOFNSigmaKvsP").c_str(), "; #it{p} (GeV/#it{c}); n#sigma TOF vs p ", o2::framework::HistType::kTH2F, {{200, 0., 5.}, {80, -10, 10}});
        mHistogramRegistry->add((folderName + "/TPCNSigmaKvsP").c_str(), "; #it{p} (GeV/#it{c}); n#sigma TPC vs p ", o2::framework::HistType::kTH2F, {{200, 0., 5.}, {80, -10, 10}});
      } else {
