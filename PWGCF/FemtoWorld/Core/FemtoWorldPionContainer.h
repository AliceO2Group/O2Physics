...
class FemtoWorldPionContainer
{
 public:
  ...
  void init(o2::framework::HistogramRegistry* registry, T1& kstarBins, T1& multBins, T1& kTBins, T1& mTBins, T2& phiBins, T2& etaBins, T2& mInvBins)
  {
    ...
    mHistogramRegistry->add((folderName + "relPairDetaDphi").c_str(), ";  #Delta#varphi (rad); #Delta#eta", o2::framework::kTH2D, {phiAxis, etaAxis});
    mHistogramRegistry->add((folderName + "relPairInvariantMass").c_str(), ";M_{K^{+}K^{-}} (GeV/#it{c}^{2});", o2::framework::kTH1D, {mInvAxis});
  }
