...
void FemtoWorldPhiSelection::init(o2::framework::HistogramRegistry* registry)
{
  if (registry) {
    ...
    mHistogramRegistry->add((folderName + "/hInvMassPhi").c_str(), "", o2::framework::HistType::kTH1F, {massAxisPhi});
    // mHistogramRegistry->add((folderName + "/hInvMassAntiPhi").c_str(), "", o2::framework::HistType::kTH1F, {massAxisAntiPhi});
    // mHistogramRegistry->add((folderName + "/hInvMassPhiPhi").c_str(), "", o2::framework::HistType::kTH2F, {massAxisPhi, massAxisPhi});
    ...
    mHistogramRegistry->add("PhiQA/hInvMassPhiNoCuts", "No cuts Phi", o2::framework::HistType::kTH1F, {massAxisPhi});
    mHistogramRegistry->add("PhiQA/hInvMassPhiInvMassCut", "Invariant mass cut Phi", o2::framework::HistType::kTH1F, {massAxisPhi});
    mHistogramRegistry->add("PhiQA/hInvMassPhiPtMin", "Minimum Pt cut", o2::framework::HistType::kTH1F, {massAxisPhi});
    mHistogramRegistry->add("PhiQA/hInvMassPhiPtMax", "Maximum Pt cut", o2::framework::HistType::kTH1F, {massAxisPhi});
    mHistogramRegistry->add("PhiQA/hInvMassPhiDCAPhiDaugh", "Phi-daughters DCA cut", o2::framework::HistType::kTH1F, {massAxisPhi});
    mHistogramRegistry->add("PhiQA/hInvMassPhiCPA", "CPA cut", o2::framework::HistType::kTH1F, {massAxisPhi});
    mHistogramRegistry->add("PhiQA/hInvMassPhiTranRadMin", "Minimum transverse radius cut", o2::framework::HistType::kTH1F, {massAxisPhi});
    mHistogramRegistry->add("PhiQA/hInvMassPhiTranRadMax", "Maximum transverse radius cut", o2::framework::HistType::kTH1F, {massAxisPhi});
    mHistogramRegistry->add("PhiQA/hInvMassPhiDecVtxMax", "Maximum distance on  decay vertex cut", o2::framework::HistType::kTH1F, {massAxisPhi});
  }
...
void FemtoWorldPhiSelection::initPhi(o2::framework::HistogramRegistry* registry)
{
  if (registry) {
    ...
    std::string folderName = static_cast<std::string>(o2::aod::femtoworldparticle::ParticleTypeName[part]);
    /// \todo initialize histograms for children tracks of v0s
    mHistogramRegistry->add((folderName + "/hPtPhi").c_str(), "; #it{p}_{T} (GeV/#it{c}); Entries", o2::framework::HistType::kTH1F, {{1000, 0, 10}});
    mHistogramRegistry->add((folderName + "/hEtaPhi").c_str(), "; #eta; Entries", o2::framework::HistType::kTH1F, {{1000, -1, 1}});
    mHistogramRegistry->add((folderName + "/hPhiPhi").c_str(), "; #phi; Entries", o2::framework::HistType::kTH1F, {{1000, 0, 2. * M_PI}});
    // mHistogramRegistry->add((folderName + "/hDaughDCA").c_str(), "; DCA^{daugh} (cm); Entries", o2::framework::HistType::kTH1F, {{1000, 0, 10}});
    // mHistogramRegistry->add((folderName + "/hTransRadius").c_str(), "; #it{r}_{xy} (cm); Entries", o2::framework::HistType::kTH1F, {{1500, 0, 150}});
    // mHistogramRegistry->add((folderName + "/hDecayVtxX").c_str(), "; #it{Vtx}_{x} (cm); Entries", o2::framework::HistType::kTH1F, {{2000, 0, 200}});
    // mHistogramRegistry->add((folderName + "/hDecayVtxY").c_str(), "; #it{Vtx}_{y} (cm)); Entries", o2::framework::HistType::kTH1F, {{2000, 0, 200}});
    ...
    mHistogramRegistry->add("PhiQA/hInvMasPhiNoCuts", "No cuts", o2::framework::HistType::kTH1F, {massAxisPhi});
    mHistogramRegistry->add("PhiQA/hInvMassPhiInvMassCut", "Invariant mass cut", o2::framework::HistType::kTH1F, {massAxisPhi});
    mHistogramRegistry->add("PhiQA/hInvMassPhiPtMin", "Minimum Pt cut", o2::framework::HistType::kTH1F, {massAxisPhi});
    mHistogramRegistry->add("PhiQA/hInvMassPhiPtMax", "Maximum Pt cut", o2::framework::HistType::kTH1F, {massAxisPhi});
    // mHistogramRegistry->add("PhiQA/hInvMassPhiDCAPhiDaugh", "Phi-daughters DCA cut", o2::framework::HistType::kTH1F, {massAxisPhi});
    // mHistogramRegistry->add("PhiQA/hInvMassPhiCPA", "CPA cut", o2::framework::HistType::kTH1F, {massAxisPhi});
