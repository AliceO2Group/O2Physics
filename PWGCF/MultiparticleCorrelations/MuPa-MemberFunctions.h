...
{ 
 ...
 if( (collision.posZ() < Vz_min) || (collision.posZ() > Vz_max) ) { return kFALSE; }
 // ...
...
{ 
 // ...
 if( (track.pt() < pt_min) || (track.pt() > pt_max) ) { return kFALSE; }
...
void SetWeightsHist(TH1D* const hist, const char *variable)
{
 ...
 if(!pw_a.fWeightsHist[ppe]){cout<<__LINE__<<endl; exit(1);} // use eventually this line
 ...
 */
 ...
 if(!alien){cout<<__LINE__<<endl;exit(1);}
