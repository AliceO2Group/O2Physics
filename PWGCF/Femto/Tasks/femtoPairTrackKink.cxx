...
struct FemtoPairTrackKink {
  ...
  {
    pairTrackSigmaBuilder.processSameEvent<modes::Mode::kSe_Reco>(col, tracks, trackPartition, sigmas, sigmaPartition, cache);
  }
  ...
  {
    pairTrackSigmaBuilder.processSameEvent<modes::Mode::kSe_Reco_Mc>(col, mcCols, tracks, trackWithLabelPartition, sigmas, sigmaWithLabelPartition, mcParticles, mcMothers, mcPartonicMothers, cache);
  }
  ...
  {
    pairTrackSigmaBuilder.processMixedEvent<modes::Mode::kMe_Reco>(cols, tracks, trackPartition, sigmaPartition, cache, mixBinsVtxMult, mixBinsVtxCent, mixBinsVtxMultCent);
  }
  ...
  {
    pairTrackSigmaBuilder.processMixedEvent<modes::Mode::kMe_Reco_Mc>(cols, mcCols, tracks, trackWithLabelPartition, sigmaWithLabelPartition, mcParticles, mcMothers, mcPartonicMothers, cache, mixBinsVtxMult, mixBinsVtxCent, mixBinsVtxMultCent);
  }
  ...
  {
    pairTrackSigmaPlusBuilder.processSameEvent<modes::Mode::kSe_Reco>(col, tracks, trackPartition, sigmaplus, sigmaPlusPartition, cache);
  }
  ...
  {
    pairTrackSigmaPlusBuilder.processSameEvent<modes::Mode::kSe_Reco_Mc>(col, mcCols, tracks, trackWithLabelPartition, sigmaplus, sigmaPlusWithLabelPartition, mcParticles, mcMothers, mcPartonicMothers, cache);
  }
  ...
  {
    pairTrackSigmaPlusBuilder.processMixedEvent<modes::Mode::kMe_Reco_Mc>(cols, mcCols, tracks, trackWithLabelPartition, sigmaPlusWithLabelPartition, mcParticles, mcMothers, mcPartonicMothers, cache, mixBinsVtxMult, mixBinsVtxCent, mixBinsVtxMultCent);
  }
...
o2::framework::WorkflowSpec defineDataProcessing(o2::framework::ConfigContext const& context)
{
  o2::framework::WorkflowSpec workflow{
    adaptAnalysisTask<FemtoPairTrackKink>(context),
  };
  return workflow;
}
