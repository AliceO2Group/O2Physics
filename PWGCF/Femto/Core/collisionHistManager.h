...
constexpr std::array<histmanager::HistInfo<ColHist>, kColHistLast> HistTable = {
  {
    ...
    // particle number correlation
    {kNpart1VsNpart2, o2::framework::HistType::kTH2F, "hNpart1VsNpart2", "# particle 1 vs # particle 2; # particle 1; # particle 2"},
    {kNpart1VsNpart2VsNpart3, o2::framework::HistType::kTHnSparseF, "hNpart1VsNpart2VsNpart3", "# particle 1 vs # particle 2 vs particle 3; # particle 1; # particle 2; # particle 3"},
    // mc
