...
/// \file FemtoFlowTrackSelection.h
/// \brief Definition of the FemtoFlowTrackSelection
...
/// \class FemtoFlowTrackCuts
/// \brief Cut class to contain and execute all cuts applied to tracks
class FemtoFlowTrackSelection : public FemtoFlowObjectSelection<float, femto_flow_track_selection::TrackSel>
{
 public:
  ...
  /// \tparam T Data type of the track
  /// \param track Track
  template <o2::aod::femtoflowparticle::ParticleType part, o2::aod::femtoflowparticle::TrackType tracktype, typename T>
  ...
  static std::string getSelectionName(femto_flow_track_selection::TrackSel iSel, std::string_view prefix = "", std::string_view suffix = "")
  {
  ...
  static femto_flow_selection::SelectionType getSelectionType(femto_flow_track_selection::TrackSel iSel)
  {
  ...
  /// \param iSel Track selection variable to be examined
  /// \param prefix Additional prefix for the output of the configurable
  static std::string getSelectionHelper(femto_flow_track_selection::TrackSel iSel, std::string_view prefix = "")
  {
    std::string outString = static_cast<std::string>(prefix);
...
void FemtoFlowTrackSelection::init(HistogramRegistry* registry)
{
  if (registry) {
    ...
    mHistogramRegistry->add((folderName + "/Chi2ITSTPCperCluster").c_str(), "; ITS_Chi2; TPC_Chi2", kTH2F, {{100, 0, 50}, {100, 0, 20}});
    mHistogramRegistry->add((folderName + "/RefitITSTPC").c_str(), "; ITS_Refit; TPC_Refit", kTH2F, {{2, 0, 2}, {2, 0, 2}});
  }
  /// set cuts
  nPtMinSel = getNSelections(femto_flow_track_selection::kpTMin);
  nPtMaxSel = getNSelections(femto_flow_track_selection::kpTMax);
  nEtaSel = getNSelections(femto_flow_track_selection::kEtaMax);
  nTPCnMinSel = getNSelections(femto_flow_track_selection::kTPCnClsMin);
  nTPCfMinSel = getNSelections(femto_flow_track_selection::kTPCfClsMin);
  nTPCcMinSel = getNSelections(femto_flow_track_selection::kTPCcRowsMin);
  nTPCsMaxSel = getNSelections(femto_flow_track_selection::kTPCsClsMax);
  nTPCsFracMaxSel = getNSelections(femto_flow_track_selection::kTPCfracsClsMax);
  nITScMinSel = getNSelections(femto_flow_track_selection::kITSnClsMin);
  nITScIbMinSel = getNSelections(femto_flow_track_selection::kITSnClsIbMin);
  nDCAxyMaxSel = getNSelections(femto_flow_track_selection::kDCAxyMax);
  nDCAzMaxSel = getNSelections(femto_flow_track_selection::kDCAzMax);
  nDCAMinSel = getNSelections(femto_flow_track_selection::kDCAMin);
  nPIDnSigmaSel = getNSelections(femto_flow_track_selection::kPIDnSigmaMax);

  pTMin = getMinimalSelection(femto_flow_track_selection::kpTMin, femto_flow_selection::kLowerLimit);
  pTMax = getMinimalSelection(femto_flow_track_selection::kpTMax, femto_flow_selection::kUpperLimit);
  etaMax = getMinimalSelection(femto_flow_track_selection::kEtaMax, femto_flow_selection::kAbsUpperLimit);
  nClsMin = getMinimalSelection(femto_flow_track_selection::kTPCnClsMin, femto_flow_selection::kLowerLimit);
  fClsMin = getMinimalSelection(femto_flow_track_selection::kTPCfClsMin, femto_flow_selection::kLowerLimit);
  cTPCMin = getMinimalSelection(femto_flow_track_selection::kTPCcRowsMin, femto_flow_selection::kLowerLimit);
  sTPCMax = getMinimalSelection(femto_flow_track_selection::kTPCsClsMax, femto_flow_selection::kUpperLimit);
  fracsTPCMax = getMinimalSelection(femto_flow_track_selection::kTPCfracsClsMax, femto_flow_selection::kUpperLimit);
  nITSclsMin = getMinimalSelection(femto_flow_track_selection::kITSnClsMin, femto_flow_selection::kLowerLimit);
  nITSclsIbMin = getMinimalSelection(femto_flow_track_selection::kITSnClsIbMin, femto_flow_selection::kLowerLimit);
  dcaXYMax = getMinimalSelection(femto_flow_track_selection::kDCAxyMax, femto_flow_selection::kAbsUpperLimit);
  dcaZMax = getMinimalSelection(femto_flow_track_selection::kDCAzMax, femto_flow_selection::kAbsUpperLimit);
  dcaMin = getMinimalSelection(femto_flow_track_selection::kDCAMin, femto_flow_selection::kAbsLowerLimit);
  nSigmaPIDMax = getMinimalSelection(femto_flow_track_selection::kPIDnSigmaMax, femto_flow_selection::kAbsUpperLimit);
}

template <typename T>
auto FemtoFlowTrackSelection::getNsigmaTPC(T const& track, o2::track::PID pid)
{
  return o2::aod::pidutils::tpcNSigma(pid, track);
}

template <typename T>
auto FemtoFlowTrackSelection::getNsigmaTOF(T const& track, o2::track::PID pid)
{
...
template <typename T>
bool FemtoFlowTrackSelection::isSelectedMinimal(T const& track)
{
...
template <typename cutContainerType, typename T>
std::array<cutContainerType, 2> FemtoFlowTrackSelection::getCutContainer(T const& track)
{
  ...
  for (auto& sel : mSelections) {
    ...
    if (selVariable == femto_flow_track_selection::kPIDnSigmaMax) {
      ...
      switch (selVariable) {
        case (femto_flow_track_selection::kSign):
          observable = sign;
          break;
        case (femto_flow_track_selection::kpTMin):
        case (femto_flow_track_selection::kpTMax):
          observable = pT;
          break;
        case (femto_flow_track_selection::kEtaMax):
          observable = eta;
          break;
        case (femto_flow_track_selection::kTPCnClsMin):
          observable = tpcNClsF;
          break;
        case (femto_flow_track_selection::kTPCfClsMin):
          observable = tpcRClsC;
          break;
        case (femto_flow_track_selection::kTPCcRowsMin):
          observable = tpcNClsC;
          break;
        case (femto_flow_track_selection::kTPCsClsMax):
          observable = tpcNClsS;
          break;
        case (femto_flow_track_selection::kTPCfracsClsMax):
          observable = tpcNClsFracS;
          break;
        case (femto_flow_track_selection::kITSnClsMin):
          observable = itsNCls;
          break;
        case (femto_flow_track_selection::kITSnClsIbMin):
          observable = itsNClsIB;
          break;
        case (femto_flow_track_selection::kDCAxyMax):
          observable = dcaXY;
          break;
        case (femto_flow_track_selection::kDCAzMax):
          observable = dcaZ;
          break;
        case (femto_flow_track_selection::kDCAMin):
          observable = dca;
          break;
        case (femto_flow_track_selection::kPIDnSigmaMax):
          break;
      }
...
template <o2::aod::femtoflowparticle::ParticleType part, o2::aod::femtoflowparticle::TrackType tracktype, typename T>
void FemtoFlowTrackSelection::fillQA(T const& track)
{
  if (mHistogramRegistry) {
    mHistogramRegistry->fill(HIST(o2::aod::femtoflowparticle::ParticleTypeName[part]) + HIST("/") + HIST(o2::aod::femtoflowparticle::TrackTypeName[tracktype]) + HIST("/hPt"), track.pt());
    mHistogramRegistry->fill(HIST(o2::aod::femtoflowparticle::ParticleTypeName[part]) + HIST("/") + HIST(o2::aod::femtoflowparticle::TrackTypeName[tracktype]) + HIST("/hEta"), track.eta());
    mHistogramRegistry->fill(HIST(o2::aod::femtoflowparticle::ParticleTypeName[part]) + HIST("/") + HIST(o2::aod::femtoflowparticle::TrackTypeName[tracktype]) + HIST("/hPhi"), track.phi());
    mHistogramRegistry->fill(HIST(o2::aod::femtoflowparticle::ParticleTypeName[part]) + HIST("/") + HIST(o2::aod::femtoflowparticle::TrackTypeName[tracktype]) + HIST("/hTPCfindable"), track.tpcNClsFindable());
    mHistogramRegistry->fill(HIST(o2::aod::femtoflowparticle::ParticleTypeName[part]) + HIST("/") + HIST(o2::aod::femtoflowparticle::TrackTypeName[tracktype]) + HIST("/hTPCfound"), track.tpcNClsFound());
    mHistogramRegistry->fill(HIST(o2::aod::femtoflowparticle::ParticleTypeName[part]) + HIST("/") + HIST(o2::aod::femtoflowparticle::TrackTypeName[tracktype]) + HIST("/hTPCcrossedOverFindalbe"), track.tpcCrossedRowsOverFindableCls());
    mHistogramRegistry->fill(HIST(o2::aod::femtoflowparticle::ParticleTypeName[part]) + HIST("/") + HIST(o2::aod::femtoflowparticle::TrackTypeName[tracktype]) + HIST("/hTPCcrossedRows"), track.tpcNClsCrossedRows());
    mHistogramRegistry->fill(HIST(o2::aod::femtoflowparticle::ParticleTypeName[part]) + HIST("/") + HIST(o2::aod::femtoflowparticle::TrackTypeName[tracktype]) + HIST("/hTPCfindableVsCrossed"), track.tpcNClsFindable(), track.tpcNClsCrossedRows());
    mHistogramRegistry->fill(HIST(o2::aod::femtoflowparticle::ParticleTypeName[part]) + HIST("/") + HIST(o2::aod::femtoflowparticle::TrackTypeName[tracktype]) + HIST("/hTPCshared"), track.tpcNClsShared());
    mHistogramRegistry->fill(HIST(o2::aod::femtoflowparticle::ParticleTypeName[part]) + HIST("/") + HIST(o2::aod::femtoflowparticle::TrackTypeName[tracktype]) + HIST("/hTPCfractionSharedCls"), track.tpcFractionSharedCls());
    mHistogramRegistry->fill(HIST(o2::aod::femtoflowparticle::ParticleTypeName[part]) + HIST("/") + HIST(o2::aod::femtoflowparticle::TrackTypeName[tracktype]) + HIST("/hITSclusters"), track.itsNCls());
    mHistogramRegistry->fill(HIST(o2::aod::femtoflowparticle::ParticleTypeName[part]) + HIST("/") + HIST(o2::aod::femtoflowparticle::TrackTypeName[tracktype]) + HIST("/hITSclustersIB"), track.itsNClsInnerBarrel());
    mHistogramRegistry->fill(HIST(o2::aod::femtoflowparticle::ParticleTypeName[part]) + HIST("/") + HIST(o2::aod::femtoflowparticle::TrackTypeName[tracktype]) + HIST("/hDCAxy"), track.pt(), track.dcaXY());
    mHistogramRegistry->fill(HIST(o2::aod::femtoflowparticle::ParticleTypeName[part]) + HIST("/") + HIST(o2::aod::femtoflowparticle::TrackTypeName[tracktype]) + HIST("/hDCAz"), track.pt(), track.dcaZ());
    mHistogramRegistry->fill(HIST(o2::aod::femtoflowparticle::ParticleTypeName[part]) + HIST("/") + HIST(o2::aod::femtoflowparticle::TrackTypeName[tracktype]) + HIST("/hDCA"), track.pt(), std::sqrt(std::pow(track.dcaXY(), 2.) + std::pow(track.dcaZ(), 2.)));
    mHistogramRegistry->fill(HIST(o2::aod::femtoflowparticle::ParticleTypeName[part]) + HIST("/") + HIST(o2::aod::femtoflowparticle::TrackTypeName[tracktype]) + HIST("/hTPCdEdX"), track.p(), track.tpcSignal());
    mHistogramRegistry->fill(HIST(o2::aod::femtoflowparticle::ParticleTypeName[part]) + HIST("/") + HIST(o2::aod::femtoflowparticle::TrackTypeName[tracktype]) + HIST("/nSigmaTPC_el"), track.p(), track.tpcNSigmaEl());
    mHistogramRegistry->fill(HIST(o2::aod::femtoflowparticle::ParticleTypeName[part]) + HIST("/") + HIST(o2::aod::femtoflowparticle::TrackTypeName[tracktype]) + HIST("/nSigmaTPC_pi"), track.p(), track.tpcNSigmaPi());
    mHistogramRegistry->fill(HIST(o2::aod::femtoflowparticle::ParticleTypeName[part]) + HIST("/") + HIST(o2::aod::femtoflowparticle::TrackTypeName[tracktype]) + HIST("/nSigmaTPC_K"), track.p(), track.tpcNSigmaKa());
    mHistogramRegistry->fill(HIST(o2::aod::femtoflowparticle::ParticleTypeName[part]) + HIST("/") + HIST(o2::aod::femtoflowparticle::TrackTypeName[tracktype]) + HIST("/nSigmaTPC_p"), track.p(), track.tpcNSigmaPr());
    mHistogramRegistry->fill(HIST(o2::aod::femtoflowparticle::ParticleTypeName[part]) + HIST("/") + HIST(o2::aod::femtoflowparticle::TrackTypeName[tracktype]) + HIST("/nSigmaTPC_d"), track.p(), track.tpcNSigmaDe());
    mHistogramRegistry->fill(HIST(o2::aod::femtoflowparticle::ParticleTypeName[part]) + HIST("/") + HIST(o2::aod::femtoflowparticle::TrackTypeName[tracktype]) + HIST("/nSigmaTOF_el"), track.p(), track.tofNSigmaEl());
    mHistogramRegistry->fill(HIST(o2::aod::femtoflowparticle::ParticleTypeName[part]) + HIST("/") + HIST(o2::aod::femtoflowparticle::TrackTypeName[tracktype]) + HIST("/nSigmaTOF_pi"), track.p(), track.tofNSigmaPi());
    mHistogramRegistry->fill(HIST(o2::aod::femtoflowparticle::ParticleTypeName[part]) + HIST("/") + HIST(o2::aod::femtoflowparticle::TrackTypeName[tracktype]) + HIST("/nSigmaTOF_K"), track.p(), track.tofNSigmaKa());
    mHistogramRegistry->fill(HIST(o2::aod::femtoflowparticle::ParticleTypeName[part]) + HIST("/") + HIST(o2::aod::femtoflowparticle::TrackTypeName[tracktype]) + HIST("/nSigmaTOF_p"), track.p(), track.tofNSigmaPr());
    mHistogramRegistry->fill(HIST(o2::aod::femtoflowparticle::ParticleTypeName[part]) + HIST("/") + HIST(o2::aod::femtoflowparticle::TrackTypeName[tracktype]) + HIST("/nSigmaTOF_d"), track.p(), track.tofNSigmaDe());
    mHistogramRegistry->fill(HIST(o2::aod::femtoflowparticle::ParticleTypeName[part]) + HIST("/") + HIST(o2::aod::femtoflowparticle::TrackTypeName[tracktype]) + HIST("/nSigmaComb_el"), track.p(), std::sqrt(track.tpcNSigmaEl() * track.tpcNSigmaEl() + track.tofNSigmaEl() * track.tofNSigmaEl()));
    mHistogramRegistry->fill(HIST(o2::aod::femtoflowparticle::ParticleTypeName[part]) + HIST("/") + HIST(o2::aod::femtoflowparticle::TrackTypeName[tracktype]) + HIST("/nSigmaComb_pi"), track.p(), std::sqrt(track.tpcNSigmaPi() * track.tpcNSigmaPi() + track.tofNSigmaPi() * track.tofNSigmaPi()));
    mHistogramRegistry->fill(HIST(o2::aod::femtoflowparticle::ParticleTypeName[part]) + HIST("/") + HIST(o2::aod::femtoflowparticle::TrackTypeName[tracktype]) + HIST("/nSigmaComb_K"), track.p(), std::sqrt(track.tpcNSigmaKa() * track.tpcNSigmaKa() + track.tofNSigmaKa() * track.tofNSigmaKa()));
    mHistogramRegistry->fill(HIST(o2::aod::femtoflowparticle::ParticleTypeName[part]) + HIST("/") + HIST(o2::aod::femtoflowparticle::TrackTypeName[tracktype]) + HIST("/nSigmaComb_p"), track.p(), std::sqrt(track.tpcNSigmaPr() * track.tpcNSigmaPr() + track.tofNSigmaPr() * track.tofNSigmaPr()));
    mHistogramRegistry->fill(HIST(o2::aod::femtoflowparticle::ParticleTypeName[part]) + HIST("/") + HIST(o2::aod::femtoflowparticle::TrackTypeName[tracktype]) + HIST("/nSigmaComb_d"), track.p(), std::sqrt(track.tpcNSigmaDe() * track.tpcNSigmaDe() + track.tofNSigmaDe() * track.tofNSigmaDe()));
    mHistogramRegistry->fill(HIST(o2::aod::femtoflowparticle::ParticleTypeName[part]) + HIST("/") + HIST(o2::aod::femtoflowparticle::TrackTypeName[tracktype]) + HIST("/Chi2ITSTPCperCluster"), track.itsChi2NCl(), track.tpcChi2NCl());
    mHistogramRegistry->fill(HIST(o2::aod::femtoflowparticle::ParticleTypeName[part]) + HIST("/") + HIST(o2::aod::femtoflowparticle::TrackTypeName[tracktype]) + HIST("/RefitITSTPC"), track.hasITS(), track.hasTPC());
  }
}
