...
/// \file FemtoFlowSelection.h
/// \brief FemtoFlowSelection - small generic class to do selections
...
namespace femto_flow_selection
{
...
class FemtoFlowSelection
{
 public:
  ...
  FemtoFlowSelection(selValDataType selVal, selVariableDataType selVar, femto_flow_selection::SelectionType selType)
    : mSelVal(selVal),
      mSelVar(selVar),
      mSelType(selType)
  {
  ...
  /// Destructor
  virtual ~FemtoFlowSelection() = default;
