...
/// \file femtoUtils.h
/// \brief Utilities for the FemtoFlow framework
...
bool isPIDSelected(aod::femtoflowparticle::CutContainerType pidcut,
                   int vSpecies,
                   int nSpecies,
                   float nSigma,
...
bool isFullPIDSelected(aod::femtoflowparticle::CutContainerType const& pidCut,
                       float momentum,
                       float pidThresh,
                       int vSpecies,
                       int nSpecies,
...
int checkDaughterType(o2::aod::femtoflowparticle::ParticleType partType, int motherPDG)
{
  int partOrigin = 0;
  if (partType == o2::aod::femtoflowparticle::ParticleType::kTrack) {

    switch (std::abs(motherPDG)) {
      case 3122:
        partOrigin = aod::femtoflow_mc_particle::ParticleOriginMCTruth::kDaughterLambda;
        break;
      case 3222:
        partOrigin = aod::femtoflow_mc_particle::ParticleOriginMCTruth::kDaughterSigmaplus;
        break;
      default:
        partOrigin = aod::femtoflow_mc_particle::ParticleOriginMCTruth::kDaughter;
    } // switch

  } else if (partType == o2::aod::femtoflowparticle::ParticleType::kV0) {
    partOrigin = aod::femtoflow_mc_particle::ParticleOriginMCTruth::kDaughter;

  } else if (partType == o2::aod::femtoflowparticle::ParticleType::kV0Child) {
    partOrigin = aod::femtoflow_mc_particle::ParticleOriginMCTruth::kDaughter;

  } else if (partType == o2::aod::femtoflowparticle::ParticleType::kCascade) {
    partOrigin = aod::femtoflow_mc_particle::ParticleOriginMCTruth::kDaughter;

  } else if (partType == o2::aod::femtoflowparticle::ParticleType::kCascadeBachelor) {
    partOrigin = aod::femtoflow_mc_particle::ParticleOriginMCTruth::kDaughter;
  }
  return partOrigin;
};
