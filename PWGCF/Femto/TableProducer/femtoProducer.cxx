...
struct FemtoProducer {
  ...
  void processMcTracks(T1 const& col, T2 const& mcCol, T3 const& tracksWithItsPid, T4 const& mcTracks)
  {
    trackBuilder.fillMcTracks<system>(col, collisionBuilder, collisionBuilderProducts, mcCol, tracksWithItsPid, trackBuilderProducts, mcTracks, mcBuilder, mcProducts);
  }
  ...
  void processResonances(T1 const& col, T2 const& /*tracks*/)
  {
    ...
    rho0Builder.fillResonances<system>(col, collisionBuilder, collisionBuilderProducts, trackBuilderProducts, twoTrackResonanceBuilderProducts, groupPositiveTracks, groupNegativeTracks, trackBuilder);
    phiBuilder.fillResonances<system>(col, collisionBuilder, collisionBuilderProducts, trackBuilderProducts, twoTrackResonanceBuilderProducts, groupPositiveTracks, groupNegativeTracks, trackBuilder);
    kstar0Builder.fillResonances<system>(col, collisionBuilder, collisionBuilderProducts, trackBuilderProducts, twoTrackResonanceBuilderProducts, groupPositiveTracks, groupNegativeTracks, trackBuilder);
    kstar0barBuilder.fillResonances<system>(col, collisionBuilder, collisionBuilderProducts, trackBuilderProducts, twoTrackResonanceBuilderProducts, groupPositiveTracks, groupNegativeTracks, trackBuilder);
  }
  ...
  {
    if (!processCollisions<modes::System::kPP_Run3_MC>(col, bcs, tracks)) {
      return;
    }
    auto tracksWithItsPid = o2::soa::Attach<consumeddata::Run3McRecoTracks, pidits::ITSNSigmaEl, pidits::ITSNSigmaPi,
                                            pidits::ITSNSigmaKa, pidits::ITSNSigmaPr, pidits::ITSNSigmaDe, pidits::ITSNSigmaTr, pidits::ITSNSigmaHe>(tracks);
    processMcTracks<modes::System::kPP_Run3_MC>(col, mcCols, tracksWithItsPid, mcParticles);
  }
