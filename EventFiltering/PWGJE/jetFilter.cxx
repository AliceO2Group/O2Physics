...
struct jetFilter {
  ...
  Filter trackFilter = (nabs(aod::track::eta) < cfgTrackEtaCut) && ((aod::track::trackCutFlag & aod::track::TrackSelectionFlags::kGlobalTrack) == aod::track::TrackSelectionFlags::kGlobalTrack) && (aod::track::pt > cfgTrackLowPtCut);
