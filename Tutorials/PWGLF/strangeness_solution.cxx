...
struct strangeness_tutorial {
  ...
  HistogramRegistry registry{"registry",
                             {{"hVertexZ", "hVertexZ", {HistType::kTH1F, {{nBins, -15., 15.}}}},
                              ...
                              {"hPtK0Short", "hPtK0Short", {HistType::kTH1F, {{ptAxis}}}},
  ...
  using DaughterTracksMC = soa::Join<aod::TracksExtra, aod::pidTPCPi, aod::McTrackLabels>;
  ...
  PROCESS_SWITCH(strangeness_tutorial, processData, "Process Data", true);

  void processMC1(soa::Filtered<soa::Join<aod::Collisions, aod::EvSels>>::iterator const& collision,
               soa::Filtered<soa::Join<aod::V0Datas, aod::McV0Labels>> const& V0s,
               DaughterTracksMC const&, // no need to define a variable for tracks, if we don't access them directly
               aod::McParticles const& mcParticles)
  {
    ...
    for (auto& v0 : V0s) {
      ...
      const auto& posDaughterTrack = v0.posTrack_as<DaughterTracksMC>();
      const auto& negDaughterTrack = v0.negTrack_as<DaughterTracksMC>();
  ...
  PROCESS_SWITCH(strangeness_tutorial, processMC1, "Process MC1", false);

  void processMC2(aod::McParticles const& mcParticles)
  {
  ...
  PROCESS_SWITCH(strangeness_tutorial, processMC2, "Process MC2", false);
};
