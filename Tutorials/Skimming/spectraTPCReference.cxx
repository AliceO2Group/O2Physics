...
struct TPCSpectraReferenceTask {
  ...
  Filter trackFilter = (nabs(aod::track::eta) < cfgCutEta) && ((aod::track::trackCutFlag & aod::track::TrackSelectionFlags::kGlobalTrack) == aod::track::TrackSelectionFlags::kGlobalTrack) && (aod::track::pt > cfgCutPt);
