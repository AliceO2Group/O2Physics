...
DECLARE_SOA_COLUMN(TrackRapidity, trackrapidity, float);     //!  dca of Electron in z direction
...
DECLARE_SOA_COLUMN(ISEMcal, isEMcal, bool);               //! dPhi  matched track to calorimeter
} // namespace etaphi
