...
struct he3LambdaDerivedAnalysis {
  ...
  Configurable<int> cfgNrotations{"cfgNrotations", 15, "Number of rotations for He3 candidates"};
  ...
  void processSameEvent(o2::aod::LFEvents::iterator const& collision, o2::aod::LFHe3 const& he3s, o2::aod::LFLambda const& lambdas)
  {
    ...
    for (const auto& he3 : he3Candidates) {
      ...
      for (int iEta{0}; iEta < 2; ++iEta) {
        for (int iR{0}; iR <= cfgMirrorEta + 1; ++iR) {
          auto he3Momentum = ROOT::Math::LorentzVector<ROOT::Math::PtEtaPhiM4D<double>>(he3.momentum.Pt(), (-1. + iEta * 2.) * he3.momentum.Eta(), he3.momentum.Phi() + 0.75 * TMath::Pi() + TMath::Pi() / 2. * iR / cfgNrotations, he3.momentum.M());
          for (const auto& lambda : lambdaCandidates) {
