...
DECLARE_SOA_COLUMN(TpcNClsFound, tpcNClsFound, int16_t);           //! Number of found TPC clusters
DECLARE_SOA_COLUMN(TpcNClsPID, tpcNClsPID, int16_t);               //! Number of TPC clusters used for PID

// event selection flags
DECLARE_SOA_COLUMN(EvSelNoSameBunchPileup, evSelNoSameBunchPileup, bool);
DECLARE_SOA_COLUMN(EvSelIsGoodZvtxFT0vsPV, evSelIsGoodZvtxFT0vsPV, bool);
DECLARE_SOA_COLUMN(EvSelIsGoodITSLayersAll, evSelIsGoodITSLayersAll, bool);
DECLARE_SOA_COLUMN(EvSelNoCollInRofStandard, evSelNoCollInRofStandard, bool);
DECLARE_SOA_COLUMN(EvSelNoHighMultCollInPrevRof, evSelNoHighMultCollInPrevRof, bool);
DECLARE_SOA_COLUMN(EvSelIsVertexITSTPC, evSelIsVertexITSTPC, bool);
DECLARE_SOA_COLUMN(EvSelNoCollInTimeRangeStandard, evSelNoCollInTimeRangeStandard, bool);
DECLARE_SOA_COLUMN(EvSelNoITSROFrameBorder, evSelNoITSROFrameBorder, bool);
DECLARE_SOA_COLUMN(EvSelNoTimeFrameBorder, evSelNoTimeFrameBorder, bool);
} // namespace pidtracks
...
DECLARE_SOA_TABLE(PidTracksData, "AOD", "PIDTRACKSDATA", //! Data tracks for comparative analysis
                  ...
                  aod::mult::MultZNA, aod::mult::MultZNC, aod::mult::MultTracklets,
                  aod::mult::MultTPC, aod::mult::MultNTracksPV,
                  aod::collision::PosZ, aod::evsel::OccupancyMedianTime, aod::cent::CentFT0C,
                  pidtracks::EvSelNoSameBunchPileup,
                  pidtracks::EvSelIsGoodZvtxFT0vsPV,
                  pidtracks::EvSelIsGoodITSLayersAll,
                  pidtracks::EvSelNoCollInRofStandard,
                  pidtracks::EvSelNoHighMultCollInPrevRof,
                  pidtracks::EvSelIsVertexITSTPC,
                  pidtracks::EvSelNoCollInTimeRangeStandard,
                  pidtracks::EvSelNoITSROFrameBorder,
                  pidtracks::EvSelNoTimeFrameBorder,
                  aod::track::TPCSignal, aod::track::TRDSignal, aod::track::TRDPattern,
                  ...
                  aod::track::SigmaTgl,
                  aod::track::Sigma1Pt,
                  aod::track::TPCNClsFindable,
                  pidtracks::TpcNClsFound,
                  pidtracks::TpcNClsPID,
                  aod::track::TPCChi2NCl,
                  aod::track::TrackTime,
                  aod::track::Length,
                  aod::track::TOFChi2,
                  aod::track::ITSClusterMap,
                  aod::track::TRDChi2);
